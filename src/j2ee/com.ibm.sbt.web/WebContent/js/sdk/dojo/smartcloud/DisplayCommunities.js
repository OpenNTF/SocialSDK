...
dojo.require("sbt.smartcloud.core");
...
dojo.declare(
	'sbt.smartcloud.communities.DisplayCommunities',
	[dijit._Widget, dijit._Templated],
	{
		id: "",
		templateString: dojo.cache("sbt.dojo.smartcloud", "templates/DisplayCommunities.html"),
		
        postCreate: function() {
        	console.log("sbt.dojo.smartcloud.DisplayCommunities created!");
		...
		_setCommunities: function(doc) {
			...
			if(doc) {
				...
				var nodes = xmlxpath.selectNodes(xml,"/a:feed/a:entry",sbt.smartcloud.namespaces);
				if(nodes) {
					var l = nodes.length;
					for(var i=0; i<l; i++) {
						var node = nodes[i];
						var div = dojo.create("div");
						this._setText(div,xmlxpath.selectText(node,"a:title",sbt.smartcloud.namespaces));
