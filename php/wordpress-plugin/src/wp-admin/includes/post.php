...
function _admin_notice_post_locked() {
	...
	?>
	<div id="post-lock-dialog" class="notification-dialog-wrap***REMOVED*** echo $hidden; ?>">
	...
	***REMOVED***
	...
	if ( $locked ) {
		...
		<div class="post-locked-avatar">***REMOVED*** echo get_avatar( $user->ID, 64 ); ?></div>
		...
		***REMOVED*** do_action( 'post_locked_dialog', $post ); ?>
		<p>
		<a class="button" href="***REMOVED*** echo esc_url( $sendback ); ?>">***REMOVED*** echo $sendback_text; ?></a>
		***REMOVED*** if ( $preview_link ) { ?>
		<a class="button***REMOVED*** echo $tab_last; ?>" href="***REMOVED*** echo esc_url( $preview_link ); ?>">***REMOVED*** _e('Preview'); ?></a>
		***REMOVED***
		}
		...
		if ( $override ) {
			?>
			<a class="button button-primary wp-tab-last" href="***REMOVED*** echo esc_url( add_query_arg( 'get-post-lock', '1', get_edit_post_link( $post->ID, 'url' ) ) ); ?>">***REMOVED*** _e('Take over'); ?></a>
			***REMOVED***
		}
		...
		***REMOVED***
		...
		<div class="post-taken-over">
			...
			<span class="locked-saving hidden"><img src="images/wpspin_light-2x.gif" width="16" height="16" /> ***REMOVED*** _e('Saving revision...'); ?></span>
			<span class="locked-saved hidden">***REMOVED*** _e('Your latest changes were saved as a revision.'); ?></span>
			</p>
			***REMOVED*** do_action( 'post_lock_lost_dialog', $post ); ?>
			<p><a class="button button-primary wp-tab-last" href="***REMOVED*** echo esc_url( $sendback ); ?>">***REMOVED*** echo $sendback_text; ?></a></p>
		</div>
		***REMOVED***
	}
