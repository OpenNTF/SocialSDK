...
***REMOVED*** else : ?>
<h2 class="nav-tab-wrapper"><a href="themes.php" class="nav-tab">***REMOVED*** echo esc_html_x('Manage Themes', 'theme'); ?></a><a href="theme-install.php" class="nav-tab nav-tab-active">***REMOVED*** echo esc_html( $title ); ?></a></h2>
...
<br class="clear" />
***REMOVED*** do_action('install_themes_' . $tab, $paged); ?>
</div>
***REMOVED***
