...
?>
		<***REMOVED*** echo $tag; ?> id="comment-***REMOVED*** comment_ID(); ?>" ***REMOVED*** comment_class(); ?>>
			<div class="comment-body">
				***REMOVED*** _e( 'Pingback:' ); ?> ***REMOVED*** comment_author_link(); ?> ***REMOVED*** edit_comment_link( __( 'Edit' ), '<span class="edit-link">', '</span>' ); ?>
			</div>
***REMOVED***
	}
...
?>
		<***REMOVED*** echo $tag; ?> ***REMOVED*** comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?> id="comment-***REMOVED*** comment_ID(); ?>">
		***REMOVED*** if ( 'div' != $args['style'] ) : ?>
		<div id="div-comment-***REMOVED*** comment_ID(); ?>" class="comment-body">
		***REMOVED*** endif; ?>
		<div class="comment-author vcard">
			***REMOVED*** if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'] ); ?>
			***REMOVED*** printf( __( '<cite class="fn">%s</cite> <span class="says">says:</span>' ), get_comment_author_link() ); ?>
		</div>
		***REMOVED*** if ( '0' == $comment->comment_approved ) : ?>
		<em class="comment-awaiting-moderation">***REMOVED*** _e( 'Your comment is awaiting moderation.' ) ?></em>
		<br />
		***REMOVED*** endif; ?>

		<div class="comment-meta commentmetadata"><a href="***REMOVED*** echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			***REMOVED***
				/* translators: 1: date, 2: time */
				printf( __( '%1$s at %2$s' ), get_comment_date(),  get_comment_time() ); ?></a>***REMOVED*** edit_comment_link( __( '(Edit)' ), '&nbsp;&nbsp;', '' );
			?>
		</div>

		***REMOVED*** comment_text( get_comment_id(), array_merge( $args, array( 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>

		<div class="reply">
			***REMOVED*** comment_reply_link( array_merge( $args, array( 'add_below' => $add_below, 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
		</div>
		***REMOVED*** if ( 'div' != $args['style'] ) : ?>
		</div>
		***REMOVED*** endif; ?>
***REMOVED***
	...
	protected function html5_comment( $comment, $depth, $args ) {
		$tag = ( 'div' === $args['style'] ) ? 'div' : 'li';
?>
		<***REMOVED*** echo $tag; ?> id="comment-***REMOVED*** comment_ID(); ?>" ***REMOVED*** comment_class( empty( $args['has_children'] ) ? '' : 'parent' ); ?>>
			<article id="div-comment-***REMOVED*** comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					<div class="comment-author vcard">
						***REMOVED*** if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'] ); ?>
						***REMOVED*** printf( __( '%s <span class="says">says:</span>' ), sprintf( '<b class="fn">%s</b>', get_comment_author_link() ) ); ?>
					</div><!-- .comment-author -->

					<div class="comment-metadata">
						<a href="***REMOVED*** echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
							<time datetime="***REMOVED*** comment_time( 'c' ); ?>">
								***REMOVED*** printf( _x( '%1$s at %2$s', '1: date, 2: time' ), get_comment_date(), get_comment_time() ); ?>
							</time>
						</a>
						***REMOVED*** edit_comment_link( __( 'Edit' ), '<span class="edit-link">', '</span>' ); ?>
					</div><!-- .comment-metadata -->

					***REMOVED*** if ( '0' == $comment->comment_approved ) : ?>
					<p class="comment-awaiting-moderation">***REMOVED*** _e( 'Your comment is awaiting moderation.' ); ?></p>
					***REMOVED*** endif; ?>
				</footer><!-- .comment-meta -->
				...
				<div class="reply">
					***REMOVED*** comment_reply_link( array_merge( $args, array( 'add_below' => 'div-comment', 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
				</div><!-- .reply -->
...
function comment_form( $args = array(), $post_id = null ) {
	...
	?>
		***REMOVED*** if ( comments_open( $post_id ) ) : ?>
			***REMOVED***
			/**
			...
			<div id="respond" class="comment-respond">
				<h3 id="reply-title" class="comment-reply-title">***REMOVED*** comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?> <small>***REMOVED*** cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small></h3>
				***REMOVED*** if ( get_option( 'comment_registration' ) && !is_user_logged_in() ) : ?>
					***REMOVED*** echo $args['must_log_in']; ?>
					***REMOVED***
					/**
					...
					?>
				***REMOVED*** else : ?>
					<form action="***REMOVED*** echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="***REMOVED*** echo esc_attr( $args['id_form'] ); ?>" class="comment-form"***REMOVED*** echo $html5 ? ' novalidate' : ''; ?>>
						***REMOVED***
						/**
						...
						***REMOVED*** if ( is_user_logged_in() ) : ?>
							...
							***REMOVED***
							...
							?>
						***REMOVED*** else : ?>
							***REMOVED*** echo $args['comment_notes_before']; ?>
							***REMOVED***
							/**
						...
						***REMOVED***
						...
						?>
						***REMOVED*** echo $args['comment_notes_after']; ?>
						<p class="form-submit">
							<input name="submit" type="submit" id="***REMOVED*** echo esc_attr( $args['id_submit'] ); ?>" value="***REMOVED*** echo esc_attr( $args['label_submit'] ); ?>" />
							***REMOVED*** comment_id_fields( $post_id ); ?>
						</p>
						***REMOVED***
						/**
