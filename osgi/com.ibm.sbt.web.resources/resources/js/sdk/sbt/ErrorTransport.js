...
dojo.provide('sbt.ErrorTransport');
/**
 * Implementation of a transport that emits an error the first time it is invoked.
 * @module sbt.ErrorTransport
 */
define('sbt/ErrorTransport',['sbt/declare','sbt/lang','sbt/Promise','sbt/stringUtil','sbt/log','sbt/i18n!sbt/nls/ErrorTransport'], function(declare,lang,Promise,stringUtil,log,nls) {
    return declare(null, {
        _called: false,
        _endpointName: null,
        _message: null,
