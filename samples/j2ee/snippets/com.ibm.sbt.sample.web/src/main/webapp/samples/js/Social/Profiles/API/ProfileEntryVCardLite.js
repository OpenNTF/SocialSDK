require([ "sbt/base/VCardDataHandler", "sbt/lang", "sbt/dom", "sbt/json", "sbt/xml", "sbt/connections/ProfileConstants" ], 
    function(VCardDataHandler,lang,dom,json,xml,consts,ProfileEntry) {
        var domNode = dom.byId("ProfileEntryVCardLite");
        var ProfileEntryVCardLite = domNode.text || domNode.textContent;

        var profileEntryHandler = new VCardDataHandler({
            data : ProfileEntryVCardLite,
