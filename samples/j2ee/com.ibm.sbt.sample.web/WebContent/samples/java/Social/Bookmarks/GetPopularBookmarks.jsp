...
<html>
<head>
<title>SBT JAVA Sample - Get Popular Bookmarks</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
</head>

<body>
	<h4>Get Popular Bookmarks </h4>
	<div id="content">
	<%
		try {
			...
			out.println("<pre>");
			out.println("Problem Occurred while fetching popular bookmarks: " + e.getMessage());
