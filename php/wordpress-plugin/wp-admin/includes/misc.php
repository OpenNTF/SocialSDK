...
<fieldset><legend class="screen-reader-text"><span>***REMOVED*** _e('Admin Color Scheme')?></span></legend>
***REMOVED***
$current_color = get_user_option('admin_color', $user_id);
if ( empty($current_color) )
	$current_color = 'fresh';
foreach ( $_wp_admin_css_colors as $color => $color_info ): ?>
<div class="color-option"><input name="admin_color" id="admin_color_***REMOVED*** echo esc_attr( $color ); ?>" type="radio" value="***REMOVED*** echo esc_attr( $color ); ?>" class="tog" ***REMOVED*** checked($color, $current_color); ?> />
	<table class="color-palette">
	<tr>
	***REMOVED*** foreach ( $color_info->colors as $html_color ): ?>
	<td style="background-color: ***REMOVED*** echo esc_attr( $html_color ); ?>" title="***REMOVED*** echo esc_attr( $color ); ?>">&nbsp;</td>
	***REMOVED*** endforeach; ?>
	</tr>
	</table>

	<label for="admin_color_***REMOVED*** echo esc_attr( $color ); ?>">***REMOVED*** echo esc_html( $color_info->name ); ?></label>
</div>
	***REMOVED*** endforeach; ?>
</fieldset>
***REMOVED***
