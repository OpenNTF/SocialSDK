...
dojo.provide("sbt.connections.controls.files.AddTagsAction");

/**
 * UploadFileAction
 */
define('sbt/connections/controls/files/AddTagsAction',[ "../../../declare", "../../../dom", "../../../lang",
	...
	var AddTagsAction = declare([ Action ], {
		...
		execute : function(selection, context) {
			...
			var dialog = this.showDialog(this.widget,{ OK: nls.labelAddTags },this.dialogArgs);
