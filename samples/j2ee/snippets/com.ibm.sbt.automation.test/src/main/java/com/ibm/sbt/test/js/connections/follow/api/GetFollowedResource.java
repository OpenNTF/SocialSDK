...
public class GetFollowedResource extends BaseCommunitiesTest {
    ...
    public void testGetFollowedResource() {
    	addSnippetParam("communityUuid", community.getCommunityUuid());
        ...
        Assert.assertEquals(community.getCommunityUuid(), json.getString("getResourceId"));
    ...
    public void testGetFollowedResourceUnknown() {
    	...
    	JavaScriptPreviewPage previewPage = executeSnippet(SNIPPET_ID);
        JsonJavaObject json = previewPage.getJson();
        Assert.assertFalse(json.getBoolean("isLoaded"));
    }
