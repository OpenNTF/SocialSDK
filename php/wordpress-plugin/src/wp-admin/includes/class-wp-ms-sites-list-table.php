	...
	function display_rows() {
		...
		foreach ( $this->items as $blog ) {
			...
			foreach ( $columns as $column_name => $column_display_name ) {
				...
				switch ( $column_name ) {
					case 'cb': ?>
						<th scope="row" class="check-column">
							***REMOVED*** if ( ! is_main_site( $blog['blog_id'] ) ) : ?>
							<label class="screen-reader-text" for="blog_***REMOVED*** echo $blog['blog_id']; ?>">***REMOVED*** printf( __( 'Select %s' ), $blogname ); ?></label>
							<input type="checkbox" id="blog_***REMOVED*** echo $blog['blog_id'] ?>" name="allblogs[]" value="***REMOVED*** echo esc_attr( $blog['blog_id'] ) ?>" />
							***REMOVED*** endif; ?>
						</th>
					***REMOVED***
					break;
					...
					***REMOVED***
					...
					case 'blogname':
						echo "<td class='column-$column_name $column_name'$style>"; ?>
							<a href="***REMOVED*** echo esc_url( network_admin_url( 'site-info.php?id=' . $blog['blog_id'] ) ); ?>" class="edit">***REMOVED*** echo $blogname . $blog_state; ?></a>
							***REMOVED***
							if ( 'list' != $mode ) {
				...
				case 'plugins': ?>
					***REMOVED*** if ( has_filter( 'wpmublogsaction' ) ) {
					echo "<td valign='top' class='$column_name column-$column_name'$style>";
