...
<div id="dialog" title="<?php echo $GLOBALS[LANG]['create_new_endpoint'];?>" style="column-width:300px;">
	...
	<button disabled="disabled" onclick="save_new_endpoint();" id="new_endpoint_save"><?php echo $GLOBALS[LANG]['save'];?></button> <button onclick="cancel_new_endpoint();" id="new_endpoint_cancel"><?php echo $GLOBALS[LANG]['cancel'];?></button>
</div>