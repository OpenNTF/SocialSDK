...
dojo.provide("sbt.data.AtomReadStore");

/**
 * @module sbt.data.AtomReadStore
 */
define('sbt/data/AtomReadStore',["../declare","../config", "../lang", "../base/core", "../xml", "../xpath","dojox/html/entities"], function(declare, config, lang, core, xml, xpath, entities) {
