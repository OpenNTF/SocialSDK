 ...
 * @date 25 Mar 2013
 */
public class GetMostCommentedWikis extends BaseWikisTest {
    
    static final String SNIPPET_ID = "Social_Wikis_API_GetMostCommentedWikis";

    public GetMostCommentedWikis() {
        setAuthType(AuthType.AUTO_DETECT);
    }

    @Test
    public void testGetMostCommentedWikis() {
