require([ "sbt/base/XmlDataHandler", "sbt/lang", "sbt/dom", "sbt/json", "sbt/xml", "sbt/connections/ProfileConstants" ], 
    function(XmlDataHandler,lang,dom,json,xml,consts,ProfileEntry) {
        var domNode = dom.byId("ProfileEntryHCardLite");
        var ProfileEntryHCardLite = domNode.text || domNode.textContent;

        var profileEntryHandler = new XmlDataHandler({
            data : ProfileEntryHCardLite,
