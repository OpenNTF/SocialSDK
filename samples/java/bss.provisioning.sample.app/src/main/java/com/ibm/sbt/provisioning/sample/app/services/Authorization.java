 ...
 * the class <code>com.ibm.sbt.services.client.smartcloud.bss.AuthorizationService</code> 
 * */
public class Authorization {
    ...
    private Authorization() {
    	this.service = new AuthorizationService(BSSProvisioning.getBasicEndpoint());
    }
