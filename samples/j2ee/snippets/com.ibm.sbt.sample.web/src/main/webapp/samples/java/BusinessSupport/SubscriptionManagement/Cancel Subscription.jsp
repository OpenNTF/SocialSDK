...
<body>
	...
	try {
		...
		String subscriptionId = "" + subscriptionList.get(0).getAsLong("SubscriptionId");
		out.println("Created subscription Id: " + subscriptionId + "<br/>");
		...
		try{
			...
			if("404".equals(responseCode)){
				out.println("Cancelled subscription Id: " + subscriptionId);
			}
		}
		...
		out.println("<pre>");
		out.println("Error cancelling subscription caused by: "+ be.getResponseJson());
		out.println("</pre>");	
	}
	
	catch (Exception e) {
		out.println("<pre>");
		out.println("Error cancelling subscription caused by: "+e.getMessage());
		out.println("</pre>");	
	}
	%>
	</div>
