...
if ( isset( $_GET['action'] ) ) {
	...
	if ( 'confirm' === $_GET['action'] ) {
		...
		<html xmlns="http://www.w3.org/1999/xhtml" ***REMOVED*** language_attributes(); ?>>
			<head>
				<title>***REMOVED*** _e( 'WordPress &rsaquo; Confirm your action' ); ?></title>
			...
			<body class="wp-core-ui">
				...
				<form action="sites.php?action=***REMOVED*** echo esc_attr( $_GET['action2'] ) ?>" method="post">
					<input type="hidden" name="action" value="***REMOVED*** echo esc_attr( $_GET['action2'] ) ?>" />
					<input type="hidden" name="id" value="***REMOVED*** echo esc_attr( $id ); ?>" />
					<input type="hidden" name="_wp_http_referer" value="***REMOVED*** echo esc_attr( wp_get_referer() ); ?>" />
					***REMOVED*** wp_nonce_field( $_GET['action2'], '_wpnonce', false ); ?>
					<p>***REMOVED*** echo esc_html( wp_unslash( $_GET['msg'] ) ); ?></p>
					***REMOVED*** submit_button( __('Confirm'), 'button' ); ?>
				</form>
			</body>
		</html>
		***REMOVED***
...
***REMOVED*** if ( current_user_can( 'create_sites') ) : ?>
	<a href="***REMOVED*** echo network_admin_url('site-new.php'); ?>" class="add-new-h2">***REMOVED*** echo esc_html_x( 'Add New', 'site' ); ?></a>
***REMOVED*** endif; ?>

***REMOVED*** if ( isset( $_REQUEST['s'] ) && $_REQUEST['s'] ) {
...
***REMOVED*** $wp_list_table->search_box( __( 'Search Sites' ), 'site' ); ?>
