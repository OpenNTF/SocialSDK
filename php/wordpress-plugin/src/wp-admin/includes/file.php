...
<form action="***REMOVED*** echo esc_url( $form_post ) ?>" method="post">
<div>
<h3>***REMOVED*** _e('Connection Information') ?></h3>
<p>***REMOVED***
...
<tr valign="top">
<th scope="row"><label for="hostname">***REMOVED*** _e('Hostname') ?></label></th>
<td><input name="hostname" type="text" id="hostname" value="***REMOVED*** echo esc_attr($hostname); if ( !empty($port) ) echo ":$port"; ?>"***REMOVED*** disabled( defined('FTP_HOST') ); ?> size="40" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="username">***REMOVED*** echo $label_user; ?></label></th>
<td><input name="username" type="text" id="username" value="***REMOVED*** echo esc_attr($username) ?>"***REMOVED*** disabled( defined('FTP_USER') ); ?> size="40" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="password">***REMOVED*** echo $label_pass; ?></label></th>
<td><div><input name="password" type="password" id="password" value="***REMOVED*** if ( defined('FTP_PASS') ) echo '*****'; ?>"***REMOVED*** disabled( defined('FTP_PASS') ); ?> size="40" /></div>
<div><em>***REMOVED*** if ( ! defined('FTP_PASS') ) _e( 'This password will not be stored on the server.' ); ?></em></div></td>
</tr>

***REMOVED*** if ( isset($types['ssh']) ) : ?>
<tr id="ssh_keys" valign="top" style="***REMOVED*** if ( 'ssh' != $connection_type ) echo 'display:none' ?>">
<th scope="row">***REMOVED*** _e('Authentication Keys') ?>
<div class="key-labels textright">
<label for="public_key">***REMOVED*** _e('Public Key:') ?></label ><br />
<label for="private_key">***REMOVED*** _e('Private Key:') ?></label>
</div></th>
<td><br /><input name="public_key" type="text" id="public_key" value="***REMOVED*** echo esc_attr($public_key) ?>"***REMOVED*** disabled( defined('FTP_PUBKEY') ); ?> size="40" /><br /><input name="private_key" type="text" id="private_key" value="***REMOVED*** echo esc_attr($private_key) ?>"***REMOVED*** disabled( defined('FTP_PRIKEY') ); ?> size="40" />
<div>***REMOVED*** _e('Enter the location on the server where the keys are located. If a passphrase is needed, enter that in the password field above.') ?></div></td>
</tr>
***REMOVED*** endif; ?>

<tr valign="top">
<th scope="row">***REMOVED*** _e('Connection Type') ?></th>
<td>
<fieldset><legend class="screen-reader-text"><span>***REMOVED*** _e('Connection Type') ?></span></legend>
***REMOVED***
	$disabled = disabled( (defined('FTP_SSL') && FTP_SSL) || (defined('FTP_SSH') && FTP_SSH), true, false );
	foreach ( $types as $name => $text ) : ?>
	<label for="***REMOVED*** echo esc_attr($name) ?>">
		<input type="radio" name="connection_type" id="***REMOVED*** echo esc_attr($name) ?>" value="***REMOVED*** echo esc_attr($name) ?>"***REMOVED*** checked($name, $connection_type); echo $disabled; ?> />
		***REMOVED*** echo $text ?>
	</label>
	***REMOVED*** endforeach; ?>
</fieldset>
