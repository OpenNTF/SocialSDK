...
class SBTKBaseWidget extends WP_Widget {
	...
	public function form($instance) {
		...
		?>
				<p>
					<label for="<?php echo $this->get_field_id('ibm-sbtk-element-id'); ?>">ID:</label> 
					<input class="widefat" id="<?php echo $this->get_field_id('ibm-sbtk-element-id'); ?>" name="<?php echo $this->get_field_name('ibm-sbtk-element-id'); ?>" type="text" value="<?php echo esc_attr($elID); ?>"/>
				</p>
				<p>
					<label for="<?php echo $this->get_field_id('ibm-sbtk-integrate'); ?>"><?php echo $GLOBALS[LANG]['integrate-with-wp']?>:</label> 
					<input <?php echo ($integrate ? 'checked="checked"' : ''); ?> id="<?php echo $this->get_field_id('ibm-sbtk-integrate'); ?>" name="<?php echo $this->get_field_name('ibm-sbtk-integrate'); ?>" type="checkbox" value="integrate" />
				</p>
			<?php 
		}
