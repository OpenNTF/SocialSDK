...
public class ActivityStreamEntry {
	...
	public static ActivityStreamEntry createActivityStreamEntryObject(DataNavigator parent){
    	...
    	Actor actor = new Actor();
    		//DataNavigator target = parent.get("target"); // ?? Check exactly what is required in this
	       ...
	       //target
	      // entryObj.setObjectType(target.stringValue("objectType"));
