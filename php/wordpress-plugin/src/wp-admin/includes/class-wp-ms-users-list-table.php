				...
				switch ( $column_name ) {
					case 'cb': ?>
						<th scope="row" class="check-column">
							<label class="screen-reader-text" for="blog_***REMOVED*** echo $user->ID; ?>">***REMOVED*** echo sprintf( __( 'Select %s' ), $user->user_login ); ?></label>
							<input type="checkbox" id="blog_***REMOVED*** echo $user->ID ?>" name="allusers[]" value="***REMOVED*** echo esc_attr( $user->ID ) ?>" />
						</th>
					***REMOVED***
					break;
					...
					case 'username':
						...
						echo "<td $attributes>"; ?>
							***REMOVED*** echo $avatar; ?><strong><a href="***REMOVED*** echo $edit_link; ?>" class="edit">***REMOVED*** echo $user->user_login; ?></a>***REMOVED***
