...
<input type="hidden" id="basic_auth_method" name="basic_auth_method" value="***REMOVED*** echo $viewData['basic_auth_method'];?>" />
...
<input type="hidden" id="endpoint_version" name="endpoint_version" value="***REMOVED*** echo $viewData['endpoint_version'];?>" />
...
<input style="display: none;" type="checkbox" id="allow_client_access" name="allow_client_access" ***REMOVED*** echo (isset($viewData['allow_client_access']) && $viewData['allow_client_access'] == true ? 'checked="checked"' : "")?> value="allow_client_access" />