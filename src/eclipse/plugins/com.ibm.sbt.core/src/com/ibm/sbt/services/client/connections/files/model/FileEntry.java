...
public class FileEntry {
    private Document data; //response feed 
	...
	public String getCreatorId() { // not in the response feed. so this is a dummy implementation.. check is we need this !!??? 
		return creatorId;
	}
	public void setCreatorId(String creatorId) {// not in the response feed. so this is a dummy implementation.. check is we need this !!???
