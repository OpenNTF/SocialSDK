...
define(["sbt/_bridge/declare",
        ...
        "dojo/string", "sbt/i18n",
        "sbt/i18n!sbt/controls/grid/connections/nls/FileGridRenderer",
        "sbt/text!sbt/controls/grid/connections/templates/FileRow.html",
        "sbt/text!sbt/controls/grid/connections/templates/RecycledFileRow.html",
        "sbt/text!sbt/controls/grid/connections/templates/FolderRow.html", 
        "sbt/text!sbt/controls/grid/connections/templates/CommentRow.html"], 
     ...
     */
    declare("sbt.controls.grid.connections.FileGridRenderer", ConnectionsGridRenderer, {
    ...
    return sbt.controls.grid.connections.FileGridRenderer;
});