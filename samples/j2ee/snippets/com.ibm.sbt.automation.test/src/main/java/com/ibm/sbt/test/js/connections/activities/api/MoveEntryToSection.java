...
public class MoveEntryToSection extends BaseActivitiesTest {
	...
	public void init() throws ClientServicesException {
		...
		sectionActivityNode = createActivityNode(activity.getActivityUuid(), "Section");
		addSnippetParam("sample.sectionId", sectionActivityNode.getActivityNodeUuid());
	...
	public void destroy() throws ClientServicesException {
		...
		deleteActivityNode(sectionActivityNode.getActivityNodeUuid());
	...
	public void testMoveActivityNodeToSection() {
		...
		Assert.assertTrue(json.getAsString("getInReplyToId").contains(sectionActivityNode.getActivityNodeUuid()));
	}
}
