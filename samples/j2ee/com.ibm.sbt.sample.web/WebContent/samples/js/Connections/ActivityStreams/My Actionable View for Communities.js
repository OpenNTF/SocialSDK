require(["sbt/connections/ActivityStreamService","sbt/dom"], function(ActivityStreamService, dom) {
	...
	activityStreamService.getMyActionableView({
		application : "communities", // Similarly other applications names can be used here. like blogs, activities, profiles. etc.
		load : function(as) {
