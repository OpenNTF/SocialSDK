...
dojo.provide('sbt.emailService');
/**
 * Provides functionality to send emails.
 * 
 * @module sbt.emailService
 */
define('sbt/emailService',['sbt/declare', 'sbt/lang', 'sbt/config', 'sbt/_bridge/Transport', 'sbt/json'], function(declare, lang, config, Transport, sbtJson) {
