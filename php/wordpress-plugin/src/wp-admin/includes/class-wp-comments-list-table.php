...
?>
			<select name="comment_type">
				<option value="">***REMOVED*** _e( 'Show all comment types' ); ?></option>
***REMOVED***
...
?>
<table class="***REMOVED*** echo implode( ' ', $this->get_table_classes() ); ?>" cellspacing="0">
	<thead>
	<tr>
		***REMOVED*** $this->print_column_headers(); ?>
	</tr>
	</thead>

	<tfoot>
	<tr>
		***REMOVED*** $this->print_column_headers( false ); ?>
	</tr>
	</tfoot>
	...
	<tbody id="the-extra-comment-list" data-wp-lists="list:comment" style="display: none;">
		***REMOVED*** $this->items = $this->extra_items; $this->display_rows(); ?>
	</tbody>
</table>
***REMOVED***
	...
	function column_cb( $comment ) {
		if ( $this->user_can ) { ?>
		<label class="screen-reader-text" for="cb-select-***REMOVED*** echo $comment->comment_ID; ?>">***REMOVED*** _e( 'Select comment' ); ?></label>
		<input id="cb-select-***REMOVED*** echo $comment->comment_ID; ?>" type="checkbox" name="delete_comments[]" value="***REMOVED*** echo $comment->comment_ID; ?>" />
		***REMOVED***
		}
	}
	...
	function column_comment( $comment ) {
		...
		comment_text();
		if ( $user_can ) { ?>
		<div id="inline-***REMOVED*** echo $comment->comment_ID; ?>" class="hidden">
		<textarea class="comment" rows="1" cols="1">***REMOVED*** echo esc_textarea( apply_filters( 'comment_edit_pre', $comment->comment_content ) ); ?></textarea>
		<div class="author-email">***REMOVED*** echo esc_attr( $comment->comment_author_email ); ?></div>
		<div class="author">***REMOVED*** echo esc_attr( $comment->comment_author ); ?></div>
		<div class="author-url">***REMOVED*** echo esc_attr( $comment->comment_author_url ); ?></div>
		<div class="comment_status">***REMOVED*** echo $comment->comment_approved; ?></div>
		</div>
		***REMOVED***
		}
...
class WP_Post_Comments_List_Table extends WP_Comments_List_Table {
	...
	function display( $output_empty = false ) {
		...
		wp_nonce_field( "fetch-list-" . get_class( $this ), '_ajax_fetch_list_nonce' );
?>
<table class="***REMOVED*** echo implode( ' ', $this->get_table_classes() ); ?>" cellspacing="0" style="display:none;">
	<tbody id="the-comment-list"***REMOVED*** if ( $singular ) echo " data-wp-lists='list:$singular'"; ?>>
		***REMOVED*** if ( ! $output_empty ) $this->display_rows_or_placeholder(); ?>
	</tbody>
</table>
***REMOVED***
	}
