...
<html>
<head>
<title>SBT Rest Client Sample - Create Activity</title>
...
<body>
	<div id="content">
		<%
			...
			+"<title type=\"text\">Activity Created On "+time+"</title>"
			...
			try {
				...
				if (postResponse.getResponse().getStatusLine().getStatusCode() == 201) {
					out.print("Successfully created Activity");
				} else {
				...
				out.println("<pre>");
				out.println("Problem Occurred while creating Activity: " + e.getMessage());
				out.println("</pre>");
