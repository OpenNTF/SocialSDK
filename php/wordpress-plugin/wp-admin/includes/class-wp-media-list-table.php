...
?>
	<tr id='post-***REMOVED*** echo $post->ID; ?>' class='***REMOVED*** echo trim( $alt . ' author-' . $post_owner . ' status-' . $post->post_status ); ?>' valign="top">
***REMOVED***
...
?>
		<th scope="row" class="check-column">
			***REMOVED*** if ( $user_can_edit ) { ?>
				<label class="screen-reader-text" for="cb-select-***REMOVED*** the_ID(); ?>">***REMOVED*** echo sprintf( __( 'Select %s' ), $att_title );?></label>
				<input type="checkbox" name="media[]" id="cb-select-***REMOVED*** the_ID(); ?>" value="***REMOVED*** the_ID(); ?>" />
			***REMOVED*** } ?>
		</th>
***REMOVED***
		break;
...
?>
				<a href="***REMOVED*** echo get_edit_post_link( $post->ID, true ); ?>" title="***REMOVED*** echo esc_attr( sprintf( __( 'Edit &#8220;%s&#8221;' ), $att_title ) ); ?>">
					***REMOVED*** echo $thumb; ?>
				</a>
...
***REMOVED***
	...
	case 'title':
?>
		<td ***REMOVED*** echo $attributes ?>><strong>
			***REMOVED*** if ( $this->is_trash || ! $user_can_edit ) {
				echo $att_title;
			} else { ?>
			<a href="***REMOVED*** echo get_edit_post_link( $post->ID, true ); ?>"
				title="***REMOVED*** echo esc_attr( sprintf( __( 'Edit &#8220;%s&#8221;' ), $att_title ) ); ?>">
				***REMOVED*** echo $att_title; ?></a>
			***REMOVED*** };
...
***REMOVED***
	...
	case 'desc':
?>
		<td ***REMOVED*** echo $attributes ?>>***REMOVED*** echo has_excerpt() ? $post->post_excerpt : ''; ?></td>
***REMOVED***
		break;
...
?>
		<td ***REMOVED*** echo $attributes ?>>***REMOVED*** echo $h_time ?></td>
***REMOVED***
		break;
...
?>
			<td ***REMOVED*** echo $attributes ?>><strong>
				***REMOVED*** if ( current_user_can( 'edit_post', $post->post_parent ) && $parent_type->show_ui ) { ?>
					<a href="***REMOVED*** echo get_edit_post_link( $post->post_parent ); ?>">
						***REMOVED*** echo $title ?></a>***REMOVED***
				} else {
					echo $title;
				} ?></strong>,
				***REMOVED*** echo get_the_time( __( 'Y/m/d' ) ); ?>
			</td>
***REMOVED***
		} else {
?>
			<td ***REMOVED*** echo $attributes ?>>***REMOVED*** _e( '(Unattached)' ); ?><br />
			***REMOVED*** if ( $user_can_edit ) { ?>
				<a class="hide-if-no-js"
					onclick="findPosts.open( 'media[]','***REMOVED*** echo $post->ID ?>' ); return false;"
					href="#the-list">
					***REMOVED*** _e( 'Attach' ); ?></a>
			***REMOVED*** } ?></td>
***REMOVED***
...
?>
		<td ***REMOVED*** echo $attributes ?>>
			***REMOVED*** do_action( 'manage_media_custom_column', $column_name, $post->ID ); ?>
		</td>
***REMOVED***
		break;
	}
