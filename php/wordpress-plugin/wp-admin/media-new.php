...
<div class="wrap">
	***REMOVED*** screen_icon(); ?>
	...
	<form enctype="multipart/form-data" method="post" action="***REMOVED*** echo admin_url('media-new.php'); ?>" class="***REMOVED*** echo esc_attr( $form_class ); ?>" id="file-form">

	***REMOVED*** media_upload_form(); ?>

	<script type="text/javascript">
	var post_id = ***REMOVED*** echo $post_id; ?>, shortform = 3;
	</script>
	<input type="hidden" name="post_id" id="post_id" value="***REMOVED*** echo $post_id; ?>" />
