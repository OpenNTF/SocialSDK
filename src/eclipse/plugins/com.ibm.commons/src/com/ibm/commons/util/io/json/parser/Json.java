...
public class Json implements JsonConstants {
  ...
  final public Object numericLiteral() throws ParseException, JsonException {
    ...
    case INTEGER_LITERAL:
      t = jj_consume_token(INTEGER_LITERAL);
                ...
                if (image.startsWith("0x") || image.startsWith("0X") ) { // $NON-NLS-1$ $NON-NLS-2$
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xa000,0x110000,0x2851e000,0x1400000,0x0,0x1400000,0x2851e000,0x0,0x28000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x2,};
   }
