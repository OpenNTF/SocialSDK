...
echo esc_html( $title );
if ( current_user_can( 'upload_files' ) ) { ?>
	<a href="media-new.php" class="add-new-h2">***REMOVED*** echo esc_html_x('Add New', 'file'); ?></a>***REMOVED***
}
if ( ! empty( $_REQUEST['s'] ) )
...
***REMOVED*** $wp_list_table->search_box( __( 'Search Media' ), 'media' ); ?>

***REMOVED*** $wp_list_table->display(); ?>

<div id="ajax-response"></div>
***REMOVED*** find_posts_div(); ?>
<br class="clear" />
