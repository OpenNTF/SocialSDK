...
<script type="text/javascript">
	var strConnectionsEndpointURL = '***REMOVED*** echo $GLOBALS[LANG]['connections_server_url']?>';
	var strSmartcloudEndpointURL = '***REMOVED*** echo $GLOBALS[LANG]['smartcloud_server_url']?>';
	var strSSLTrustError = '***REMOVED*** echo $GLOBALS[LANG]['ssl_trust_error']?>';
	var strEndpointNameError = '***REMOVED*** echo $GLOBALS[LANG]['endpoint_name_error']?>';
	...
	function ibm_sbt_generate_callback_url() {
		...
		var url = "***REMOVED*** echo BASE_LOCATION . '/core/index.php?classpath=endpoint&class=SBTOAuth2Endpoint&method=authenticationCallback&endpointName='?>";
		url += endpointName;
...
?>
<div id="dialog" title="***REMOVED*** echo $GLOBALS[LANG]['create_new_endpoint'];?>" style="column-width:300px;">
	<table>
		<tr>
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['server_type'];?>
			</td>
			<td>
				<select onchange="new_server_type_change();" id="new_server_type" name="new_server_type">
					...
					<option value="connections">***REMOVED*** echo $GLOBALS[LANG]['ibm_connections']; ?></option>
					<option value="smartcloud">***REMOVED*** echo $GLOBALS[LANG]['ibm_smartcloud']; ?></option>
				</select>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['endpoint_name'];?>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input size="50" type="text" id="new_endpoint_version" name="new_endpoint_version" value="" />(***REMOVED*** echo $GLOBALS[LANG]['optional'];?>)
			</td>
		</tr>
		<tr style="display: none;" id="tr_force_ssl_trust">
			<td style="width: 200px;">
				<input type="checkbox" checked="checked" id="new_force_ssl_trust" name="new_force_ssl_trust" value="force_ssl_trust" />&nbsp;***REMOVED*** echo $GLOBALS[LANG]['force_ssl_trust'];?>
			</td>
			<td style="width: 200px;">
	...
	<table>
		<tr style="display: none;" id="tr_new_consumer_key">
			<td style="width: 200px;" id="lb_new_consumer_key">
				***REMOVED*** echo $GLOBALS[LANG]['consumer_key'];?>
			</td>
			<td>
		...
		<tr style="display: none;" id="tr_new_consumer_secret">
			<td style="width: 200px;" id="lb_new_consumer_secret">
				***REMOVED*** echo $GLOBALS[LANG]['consumer_secret'];?>
			</td>
			<td>
		...
		<tr style="display: none;" id="tr_new_authorization_url">
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['authorization_url'];?>
			</td>
			<td>
		...
		<tr style="display: none;" id="tr_new_request_token_url">
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['request_token_url'];?>
			</td>
			<td>
		...
		<tr style="display: none;" id="tr_new_access_token_url">
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['access_token_url'];?>
			</td>
			<td>
		...
		<tr style="display: none;" id="tr_new_basic_auth_password">
			<td style="width: 200px;">
				***REMOVED*** echo $GLOBALS[LANG]['password'];?>
			</td>
			<td>
