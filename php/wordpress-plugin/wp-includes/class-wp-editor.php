...
?>
	...
	<script type="text/javascript">
		tinyMCEPreInit = {
			base : "***REMOVED*** echo self::$baseurl; ?>",
			suffix : "***REMOVED*** echo $suffix; ?>",
			query : "***REMOVED*** echo $version; ?>",
			mceInit : ***REMOVED*** echo $mceInit; ?>,
			qtInit : ***REMOVED*** echo $qtInit; ?>,
			ref : ***REMOVED*** echo self::_parse_init( $ref ); ?>,
...
?>
	...
	<script type="text/javascript">
		...
		(function(){
			var init, ed, qt, first_init, DOM, el, i, mce = ***REMOVED*** echo (int) $mce; ?>;
	...
	?>
	<div id="wp-fullscreen-body"***REMOVED*** if ( is_rtl() ) echo ' class="rtl"'; ?>>
	<div id="fullscreen-topbar">
		<div id="wp-fullscreen-toolbar">
			<div id="wp-fullscreen-close"><a href="#" onclick="fullscreen.off();return false;">***REMOVED*** _e('Exit fullscreen'); ?></a></div>
			<div id="wp-fullscreen-central-toolbar" style="width:***REMOVED*** echo $width; ?>px;">

			<div id="wp-fullscreen-mode-bar"><div id="wp-fullscreen-modes">
				<a href="#" onclick="fullscreen.switchmode('tinymce');return false;">***REMOVED*** _e( 'Visual' ); ?></a>
				<a href="#" onclick="fullscreen.switchmode('html');return false;">***REMOVED*** _ex( 'Text', 'Name for the Text editor tab (formerly HTML)' ); ?></a>
			</div></div>
	...
	***REMOVED***		continue;
			...
			<div***REMOVED*** if ( $args['both'] ) { ?> class="wp-fullscreen-both"***REMOVED*** } ?>>
			<a title="***REMOVED*** echo $args['title']; ?>" onclick="***REMOVED*** echo $args['onclick']; ?>return false;" class="mceButton mceButtonEnabled mce_***REMOVED*** echo $button; ?>" href="#" id="wp_fs_***REMOVED*** echo $button; ?>" role="button" aria-pressed="false">
			<span class="mceIcon mce_***REMOVED*** echo $button; ?>"></span>
			</a>
			</div>
	***REMOVED***
		} ?>
			...
			<div id="wp-fullscreen-save">
				<input type="button" class="button-primary right" value="***REMOVED*** echo $save; ?>" onclick="fullscreen.save();" />
				<span class="spinner"></span>
				<span class="fs-saved">***REMOVED*** if ( $post->post_status == 'publish' ) _e('Updated.'); else _e('Saved.'); ?></span>
			</div>
	...
	<div id="wp-fullscreen-wrap" style="width:***REMOVED*** echo $dfw_width; ?>px;">
		***REMOVED*** if ( post_type_supports($post->post_type, 'title') ) { ?>
		<label id="wp-fullscreen-title-prompt-text" for="wp-fullscreen-title">***REMOVED*** echo apply_filters( 'enter_title_here', __( 'Enter title here' ), $post ); ?></label>
		...
		***REMOVED*** } ?>
		...
		<div id="wp-fullscreen-status">
			<div id="wp-fullscreen-count">***REMOVED*** printf( __( 'Word count: %s' ), '<span class="word-count">0</span>' ); ?></div>
			<div id="wp-fullscreen-tagline">***REMOVED*** _e('Just write.'); ?></div>
		</div>
	</div>
	</div>
	...
	***REMOVED*** wp_nonce_field( 'internal-linking', '_ajax_linking_nonce', false ); ?>
	<div id="link-selector">
		<div id="link-options">
			<p class="howto">***REMOVED*** _e( 'Enter the destination URL' ); ?></p>
			<div>
				<label><span>***REMOVED*** _e( 'URL' ); ?></span><input id="url-field" type="text" name="href" /></label>
			</div>
			<div>
				<label><span>***REMOVED*** _e( 'Title' ); ?></span><input id="link-title-field" type="text" name="linktitle" /></label>
			</div>
			<div class="link-target">
				<label><input type="checkbox" id="link-target-checkbox" /> ***REMOVED*** _e( 'Open link in a new window/tab' ); ?></label>
			</div>
		</div>
		***REMOVED*** $show_internal = '1' == get_user_setting( 'wplink', '0' ); ?>
		<p class="howto toggle-arrow ***REMOVED*** if ( $show_internal ) echo 'toggle-arrow-active'; ?>" id="internal-toggle">***REMOVED*** _e( 'Or link to existing content' ); ?></p>
		<div id="search-panel"***REMOVED*** if ( ! $show_internal ) echo ' style="display:none"'; ?>>
			<div class="link-search-wrapper">
				<label>
					<span class="search-label">***REMOVED*** _e( 'Search' ); ?></span>
			...
			<div id="most-recent-results" class="query-results">
				<div class="query-notice"><em>***REMOVED*** _e( 'No search term specified. Showing recent items.' ); ?></em></div>
				<ul></ul>
				<div class="river-waiting">
					<span class="spinner"></span>
				</div>
	...
	<div class="submitbox">
		<div id="wp-link-update">
			<input type="submit" value="***REMOVED*** esc_attr_e( 'Add Link' ); ?>" class="button-primary" id="wp-link-submit" name="wp-link-submit">
		</div>
		<div id="wp-link-cancel">
			<a class="submitdelete deletion" href="#">***REMOVED*** _e( 'Cancel' ); ?></a>
		</div>
	</div>
	</form>
	</div>
