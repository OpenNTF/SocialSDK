...
define(["sbt/_bridge/declare",
        ...
        "sbt/i18n!sbt/controls/grid/connections/nls/ProfileGridRenderer",
        "sbt/text!sbt/controls/grid/connections/templates/ProfileRow.html",
        "sbt/text!sbt/controls/grid/connections/templates/SharedConnectionsRow.html",
        "sbt/text!sbt/controls/grid/connections/templates/StatusUpdateRow.html"], 
     ...
     */
    declare("sbt.controls.grid.connections.ProfileGridRenderer", ConnectionsGridRenderer, {
    ...
    return sbt.controls.grid.connections.ProfileGridRenderer;
});