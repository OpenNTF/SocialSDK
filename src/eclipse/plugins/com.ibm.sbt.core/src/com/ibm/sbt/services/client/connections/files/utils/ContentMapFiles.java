...
public class ContentMapFiles {
	   ...
	   static {
		    ...
		    String[][] pairs = {
		    		...
		    		{	"commentFromEntry",			"/a:entry/a:content" 									},
		    		{	"comment",	 				"/a:feed/a:entry/a:content"								},
		    		{	"entry" , 					"/a:feed/a:entry"										},
		    		{	"uuidFromEntry"	,			"/a:entry/td:uuid"										},
		    		{	"lockFromEntry"	,			"/a:entry/td:lock/@type"								},
		    		{	"labelFromEntry",			"/a:entry/td:label"										},
		    		...
		    		{	"titleFromEntry",			"/a:entry/a:title"										},
		    		{	"totalResults",				"/a:feed/opensearch:totalResults"						},
		    		{	"publishedFromEntry",		"/a:entry/a:published" 									},
		    		{	"updatedFromEntry",			"/a:entry/a:updated"									},
		    		{	"createdFromEntry",			"/a:entry/td:created"									},
		    		{	"modifiedFromEntry",		"/a:entry/td:modified"	},
