...
if ( isset($_GET['editwidget']) && $_GET['editwidget'] ) {
	...
	***REMOVED*** screen_icon(); ?>
	...
	<div class="editwidget"***REMOVED*** echo $width; ?>>
	<h3>***REMOVED*** printf( __( 'Widget %s' ), $name ); ?></h3>
...
***REMOVED***
	...
	<p class="describe">***REMOVED*** _e('Select both the sidebar for this widget and the position of the widget in that sidebar.'); ?></p>
	<div class="widget-position">
	<table class="widefat"><thead><tr><th>***REMOVED*** _e('Sidebar'); ?></th><th>***REMOVED*** _e('Position'); ?></th></tr></thead><tbody>
***REMOVED***
...
***REMOVED***
	if ( isset($_GET['addnew']) ) { ?>
	<a href="widgets.php" class="button alignleft">***REMOVED*** _e('Cancel'); ?></a>
***REMOVED***
	} else {
	...
	<input type="hidden" name="widget-id" class="widget-id" value="***REMOVED*** echo esc_attr($widget_id); ?>" />
	<input type="hidden" name="id_base" class="id_base" value="***REMOVED*** echo esc_attr($id_base); ?>" />
	<input type="hidden" name="multi_number" class="multi_number" value="***REMOVED*** echo esc_attr($multi_number); ?>" />
***REMOVED***	wp_nonce_field("save-delete-widget-$widget_id"); ?>
	<br class="clear" />
	</div>
	</form>
	</div>
...
***REMOVED*** if ( isset($_GET['message']) && isset($messages[$_GET['message']]) ) { ?>
<div id="message" class="updated"><p>***REMOVED*** echo $messages[$_GET['message']]; ?></p></div>
***REMOVED*** } ?>
***REMOVED*** if ( isset($_GET['error']) && isset($errors[$_GET['error']]) ) { ?>
<div id="message" class="error"><p>***REMOVED*** echo $errors[$_GET['error']]; ?></p></div>
***REMOVED*** } ?>
...
<div id="widgets-left">
	<div id="available-widgets" class="widgets-holder-wrap">
		...
		<h3>***REMOVED*** _e('Available Widgets'); ?> <span id="removing-widget">***REMOVED*** _ex('Deactivate', 'removing-widget'); ?> <span></span></span></h3></div>
		<div class="widget-holder">
		<p class="description">***REMOVED*** _e('Drag widgets from here to a sidebar on the right to activate them. Drag widgets back here to deactivate them and delete their settings.'); ?></p>
		<div id="widget-list">
		***REMOVED*** wp_list_widgets(); ?>
		</div>
		<br class='clear' />
		</div>
		<br class="clear" />
...
?>
		...
		<div class="***REMOVED*** echo esc_attr( $wrap_class ); ?>">
			<div class="sidebar-name">
				<div class="sidebar-name-arrow"><br /></div>
				<h3>***REMOVED*** echo esc_html( $registered_sidebar['name'] ); ?>
					<span class="spinner"></span>
				</h3>
			</div>
			<div class="widget-holder inactive">
				***REMOVED*** wp_list_widget_controls( $registered_sidebar['id'] ); ?>
				<div class="clear"></div>
			</div>
		</div>
***REMOVED***
...
foreach ( $wp_registered_sidebars as $sidebar => $registered_sidebar ) {
	...
	***REMOVED*** wp_list_widget_controls( $sidebar ); // Show the control forms for each of the widgets in this sidebar ?>
	</div>
***REMOVED***
	$i++;
} ?>
...
***REMOVED*** wp_nonce_field( 'save-sidebar-widgets', '_wpnonce_widgets', false ); ?>
</form>
<br class="clear" />
</div>
