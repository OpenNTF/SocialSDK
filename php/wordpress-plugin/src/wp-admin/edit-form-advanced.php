...
?></h2>
***REMOVED*** if ( $notice ) : ?>
<div id="notice" class="error"><p id="has-newer-autosave">***REMOVED*** echo $notice ?></p></div>
***REMOVED*** endif; ?>
***REMOVED*** if ( $message ) : ?>
<div id="message" class="updated"><p>***REMOVED*** echo $message; ?></p></div>
***REMOVED*** endif; ?>
<div id="lost-connection-notice" class="error hidden">
	<p><span class="spinner"></span> ***REMOVED*** _e( '<strong>Connection lost.</strong> Saving has been disabled until you&#8217;re reconnected.' ); ?>
	<span class="hide-if-no-sessionstorage">***REMOVED*** _e( 'We&#8217;re backing up this post in your browser, just in case.' ); ?></span>
	</p>
</div>
***REMOVED***
/**
 ...
 */
?>
<form name="post" action="post.php" method="post" id="post"***REMOVED*** do_action( 'post_edit_form_tag', $post ); ?>>
***REMOVED*** wp_nonce_field($nonce_action); ?>
<input type="hidden" id="user-id" name="user_ID" value="***REMOVED*** echo (int) $user_ID ?>" />
<input type="hidden" id="hiddenaction" name="action" value="***REMOVED*** echo esc_attr( $form_action ) ?>" />
<input type="hidden" id="originalaction" name="originalaction" value="***REMOVED*** echo esc_attr( $form_action ) ?>" />
<input type="hidden" id="post_author" name="post_author" value="***REMOVED*** echo esc_attr( $post->post_author ); ?>" />
<input type="hidden" id="post_type" name="post_type" value="***REMOVED*** echo esc_attr( $post_type ) ?>" />
<input type="hidden" id="original_post_status" name="original_post_status" value="***REMOVED*** echo esc_attr( $post->post_status) ?>" />
<input type="hidden" id="referredby" name="referredby" value="***REMOVED*** echo esc_url(wp_get_referer()); ?>" />
***REMOVED*** if ( ! empty( $active_post_lock ) ) { ?>
<input type="hidden" id="active_post_lock" value="***REMOVED*** echo esc_attr( implode( ':', $active_post_lock ) ); ?>" />
***REMOVED***
}
...
<div id="poststuff">
<div id="post-body" class="metabox-holder columns-***REMOVED*** echo 1 == get_current_screen()->get_columns() ? '1' : '2'; ?>">
<div id="post-body-content">

***REMOVED*** if ( post_type_supports($post_type, 'title') ) { ?>
<div id="titlediv">
<div id="titlewrap">
	***REMOVED***
	/**
	 ...
	 */
	?>
	<label class="screen-reader-text" id="title-prompt-text" for="title">***REMOVED*** echo apply_filters( 'enter_title_here', __( 'Enter title here' ), $post ); ?></label>
	<input type="text" name="post_title" size="30" value="***REMOVED*** echo esc_attr( htmlspecialchars( $post->post_title ) ); ?>" id="title" autocomplete="off" />
</div>
<div class="inside">
***REMOVED***
...
***REMOVED*** wp_editor( $post->post_content, 'content', array(
	'dfw' => true,
	'tabfocus_elements' => 'insert-media-button,save-post',
	'editor_height' => 360,
) ); ?>
<table id="post-status-info" cellspacing="0"><tbody><tr>
	<td id="wp-word-count">***REMOVED*** printf( __( 'Word count: %s' ), '<span class="word-count">0</span>' ); ?></td>
...
***REMOVED*** if ( post_type_supports( $post_type, 'title' ) && '' === $post->post_title ) : ?>
