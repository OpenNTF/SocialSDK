...
<head>
	...
	<title>***REMOVED*** _e( 'WordPress &rsaquo; Database Repair' ); ?></title>
	***REMOVED***
...
?>
	<p class="step"><a class="button button-large" href="repair.php?repair=1">***REMOVED*** _e( 'Repair Database' ); ?></a></p>
	<p>***REMOVED*** _e( 'WordPress can also attempt to optimize the database. This improves performance in some situations. Repairing and optimizing the database can take a long time and the database will be locked while optimizing.' ); ?></p>
	<p class="step"><a class="button button-large" href="repair.php?repair=2">***REMOVED*** _e( 'Repair and Optimize Database' ); ?></a></p>
***REMOVED***
}
?>
</body>
