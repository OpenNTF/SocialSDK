...
/**
 * A convenience class for dealing with resource bundles and formatting
 * messages
 * @ibm-not_published
 */
public class ResourceBundleHelper {
    ...
    /**
     * Constructor for ResourceBundleHelper.
     * @param bundle the ResourceBundle we're helping
     */
  ...
  /**
     ...
     * The error code is a ten digit string that starts after the equal sign and 
     * identifies a specific error. The format is:
    ...
    public String getString(String key, Object[] params) {
        return _formatter.format(_bundle.getString(key), params);
    }
