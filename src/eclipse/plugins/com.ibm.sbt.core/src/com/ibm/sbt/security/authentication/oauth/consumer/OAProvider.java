 ...
 * does not hold the token specific to a user.<br>
 * Such a service should be added as a bean, which can be application specific or shared
 * between all the applications.
 * </p>
 * @author Philippe Riand
 * 
 * /////// TEMP ////////
 * Sample values for Greenhouse (https://greenhouse.lotus.com/vulcan/security/provider/register.jsp?serviceProvider=vulcanToolkit)
 *  consumerKey:      eecaba0d-136c-4677-a614-0b41612a2430
 *  consumerSecret:   IaL348_VDilHbgWSKm5Z64gvI0AIPWwObY0aVh1xKUx7m7VMrH65nnlxXfSU0vRzGqIjg8lHgP8etdlp8DuHGA
...
public class OAProvider implements Serializable{
    ...
    private static final ProfilerType profilerLoadTokenStore = new ProfilerType("OAuth: Load a token from the store"); //$NON-NLS-1$
     ...
     */
    public  AccessToken createToken(String appId, String serviceName, OAuth1Handler handler, String userId) throws OAuthException {
