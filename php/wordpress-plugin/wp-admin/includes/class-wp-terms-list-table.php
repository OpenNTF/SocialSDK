...
?>
	...
	<form method="get" action=""><table style="display: none"><tbody id="inlineedit">
		<tr id="inline-edit" class="inline-edit-row" style="display: none"><td colspan="***REMOVED*** echo $this->get_column_count(); ?>" class="colspanchange">

			<fieldset><div class="inline-edit-col">
				<h4>***REMOVED*** _e( 'Quick Edit' ); ?></h4>

				<label>
					<span class="title">***REMOVED*** _ex( 'Name', 'term name' ); ?></span>
	...
	***REMOVED***
	...
	?>
		...
		<p class="inline-edit-save submit">
			<a accesskey="c" href="#inline-edit" class="cancel button-secondary alignleft">***REMOVED*** _e( 'Cancel' ); ?></a>
			<a accesskey="s" href="#inline-edit" class="save button-primary alignright">***REMOVED*** echo $tax->labels->update_item; ?></a>
			<span class="spinner"></span>
			<span class="error" style="display:none;"></span>
			***REMOVED*** wp_nonce_field( 'taxinlineeditnonce', '_inline_edit', false ); ?>
			<input type="hidden" name="taxonomy" value="***REMOVED*** echo esc_attr( $this->screen->taxonomy ); ?>" />
			<input type="hidden" name="post_type" value="***REMOVED*** echo esc_attr( $this->screen->post_type ); ?>" />
			<br class="clear" />
		</p>
		</td></tr>
		</tbody></table></form>
