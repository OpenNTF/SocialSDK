...
<body>
	...
	<%
		try {
			...
			EntityList<CMISFile> files = fileService.getMyCollections(); 
			if(files != null && ! files.isEmpty()) {
				out.println("My Collections<br>");
			...
			files = fileService.getCollectionsSharedWithMe(); 
			if(files != null && ! files.isEmpty()) {
				out.println("<br>Collections Shared with Me<br>");
				for (CMISFile file : files) {
					out.println("Collections fetched = " + file.getId());
				} 
			}else {
				out.println("No Results");
			}
