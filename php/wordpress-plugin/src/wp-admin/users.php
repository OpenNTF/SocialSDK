...
***REMOVED*** wp_nonce_field('delete-users') ?>
***REMOVED*** echo $referer; ?>

<div class="wrap">
***REMOVED*** screen_icon(); ?>
<h2>***REMOVED*** _e('Delete Users'); ?></h2>
***REMOVED*** if ( isset( $_REQUEST['error'] ) ) : ?>
<div class="error">
	<p><strong>***REMOVED*** _e( 'ERROR:' ); ?></strong> ***REMOVED*** _e( 'Please select an option.' ); ?></p>
</div>
***REMOVED*** endif; ?>
<p>***REMOVED*** echo _n( 'You have specified this user for deletion:', 'You have specified these users for deletion:', count( $userids ) ); ?></p>
<ul>
***REMOVED***
	$go_delete = 0;
	foreach ( $userids as $id ) {
...
***REMOVED*** if ( $go_delete ) : ?>
	<fieldset><p><legend>***REMOVED*** echo _n( 'What should be done with posts owned by this user?', 'What should be done with posts owned by these users?', $go_delete ); ?></legend></p>
	<ul style="list-style:none;">
		<li><label><input type="radio" id="delete_option0" name="delete_option" value="delete" />
		***REMOVED*** _e('Delete all posts.'); ?></label></li>
		<li><input type="radio" id="delete_option1" name="delete_option" value="reassign" />
		***REMOVED*** echo '<label for="delete_option1">' . __( 'Attribute all posts to:' ) . '</label> ';
		wp_dropdown_users( array( 'name' => 'reassign_user', 'exclude' => array_diff( $userids, array($current_user->ID) ) ) ); ?></li>
	</ul></fieldset>
	<input type="hidden" name="action" value="dodelete" />
	***REMOVED*** submit_button( __('Confirm Deletion'), 'secondary' ); ?>
***REMOVED*** else : ?>
	<p>***REMOVED*** _e('There are no valid users selected for deletion.'); ?></p>
***REMOVED*** endif; ?>
</div>
</form>
***REMOVED***
...
?>
<form action="" method="post" name="updateusers" id="updateusers">
***REMOVED*** wp_nonce_field('remove-users') ?>
***REMOVED*** echo $referer; ?>

<div class="wrap">
***REMOVED*** screen_icon(); ?>
<h2>***REMOVED*** _e('Remove Users from Site'); ?></h2>
<p>***REMOVED*** _e('You have specified these users for removal:'); ?></p>
<ul>
***REMOVED***
	$go_remove = false;
 	foreach ( $userids as $id ) {
 	...
 	?>
***REMOVED*** if ( $go_remove ) : ?>
		<input type="hidden" name="action" value="doremove" />
		***REMOVED*** submit_button( __('Confirm Removal'), 'secondary' ); ?>
***REMOVED*** else : ?>
	<p>***REMOVED*** _e('There are no valid users selected for removal.'); ?></p>
***REMOVED*** endif; ?>
</div>
</form>
***REMOVED***
