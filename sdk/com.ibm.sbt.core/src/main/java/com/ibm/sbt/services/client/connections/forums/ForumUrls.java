...
public enum ForumUrls implements URLContainer {
	...
	FORUM(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/forum")),
	...
	TAGS_TOPICS(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/tags/topics")),
	RECOMMENDATION_ENTRIES(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/recommendation/entries")),
	TOPIC(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/topic")),
	TOPICS(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/topics")),
	TOPICS_MY(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/topics/my")),
	REPLIES(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/replies")),
	REPLY(new VersionedUrl(ConnectionsConstants.v4_0, "forums/{authType}/atom/reply"));
