			...
			<tr>
				...
				<td>
					<fieldset>
						...
						<input type="radio" name="_visibility" value="public" title="${nls.titleShareEveryone}" dojoattachpoint="publicInput">

					</fieldset>
				
					<div>
						<input type="checkbox"  name="_shareFilePropagate"	value="true" checked="" dojoattachpoint="propagateInput">
...
<div role="dialog" style="${style}" >
	...
	<div dojoattachpoint="containerNode">
		<div style="${dialogStyle}">
			<form>
				<div style="padding-left:0.5em;padding-top:0.5em;" aria-label="${title}">
					<span class="lead">${title}</span>
					<button style="padding-right:0.3em;" type="button" class="close" data-dismiss="modal" aria-hidden="true" dojoattachevent="onclick: onCancel" title="${nls.Close}">&times;</button>
				</div>
				<div>
				<div>
