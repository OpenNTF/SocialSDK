 ...
 *
 */
public class UnassignRoleTest extends BaseBssTest {
    ...
    public void testUnassignRole() {
    	try {
    		...
    		authorizationService.unassignRole(loginName, "CustomerPurchaser");
			...
			Assert.assertTrue(arrayContains("User", roles));
			Assert.assertFalse(arrayContains("CustomerAdministrator", roles));
			Assert.assertFalse(arrayContains("CustomerPurchaser", roles));
