require(["sbt/connections/ActivityStreamService", "sbt/dom"], function(ActivityStreamService, dom) {
	...
	activityStreamService.search({
		query: "test",
		queryLanguage: "en", //supported parameters(all optional): query, queryLanguage, filters, dateFilter,facetRequests, preferSearchIndex, snapshot.
		load : function(as) {
