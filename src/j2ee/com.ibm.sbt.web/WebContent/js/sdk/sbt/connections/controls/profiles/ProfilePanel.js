...
define(["../../../declare", "../../../lang", 
        ...
        function(declare, lang, ProfileService, _ProfilePanel) {
    ...
    var ProfilePanel = declare([ _ProfilePanel ], {
        ...
        constructor: function(args) {
            this.profileService = new ProfileService(this._getEndpoint());
        },
        ...
        getProfile: function(id) {
        	var self = this;
            var promise = this.profileService.getProfile(id);
            promise.then(    
                function(profile) {
