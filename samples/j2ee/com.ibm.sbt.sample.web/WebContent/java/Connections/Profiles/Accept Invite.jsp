...
<head>
	...
	<%
		...
		String connectionId = "ddb3f18a-3968-4ec6-abc8-54a7906b94c7";
		String title = "Boyd Gossens";
		String msg = "accepted ur invite";
		boolean success = connProfSvc.acceptInvite(connectionId, title, msg);  
		if(success){
			out.println("Invite accepted");
		}
		else{
			out.println("error in accepting invite");
		}
