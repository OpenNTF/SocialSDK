...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	function display_rows() {
		...
		?>
		<tr>
			<td class="name column-name"***REMOVED*** echo $style['name']; ?>><strong>***REMOVED*** echo $title; ?></strong>
				<div class="action-links">***REMOVED*** if ( !empty( $action_links ) ) echo implode( ' | ', $action_links ); ?></div>
			</td>
			<td class="vers column-version"***REMOVED*** echo $style['version']; ?>>***REMOVED*** echo $version; ?></td>
			<td class="vers column-rating"***REMOVED*** echo $style['rating']; ?>>
				<div class="star-holder" title="***REMOVED*** printf( _n( '(based on %s rating)', '(based on %s ratings)', $plugin['num_ratings'] ), number_format_i18n( $plugin['num_ratings'] ) ) ?>">
					<div class="star star-rating" style="width: ***REMOVED*** echo esc_attr( str_replace( ',', '.', $plugin['rating'] ) ); ?>px"></div>
				</div>
			</td>
			<td class="desc column-description"***REMOVED*** echo $style['description']; ?>>***REMOVED*** echo $description, $author; ?></td>
		</tr>
		***REMOVED***
		}
	}
