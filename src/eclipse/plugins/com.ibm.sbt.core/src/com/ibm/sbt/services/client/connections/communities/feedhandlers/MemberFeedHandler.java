...
import com.ibm.sbt.services.client.connections.communities.MemberXPath;
...
public class MemberFeedHandler implements IFeedHandler {
	...
	public Member createEntityFromData(Object data) {
		Node node = (Node)data;
		XPathExpression expr = (data instanceof Document) ? (XPathExpression)MemberXPath.entry.getPath() : null;
