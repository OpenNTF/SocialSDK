...
<%@page import="com.ibm.sbt.services.client.TwitterClientService"%>
...
<%-- <%@page import="com.ibm.sbt.runtime.Application"%>
<%@page import="com.ibm.sbt.runtime.Context"%>
 --%><%@page
...
<body>
	...
	<%
		...
		ClientService svc = new TwitterClientService(EndpointFactory.getEndpoint("twitter"));
