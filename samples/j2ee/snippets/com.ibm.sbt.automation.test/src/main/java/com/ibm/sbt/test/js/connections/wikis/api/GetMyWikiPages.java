 ...
 * @date 25 Mar 2013
 */
public class GetMyWikiPages extends BaseWikisTest {
    
    static final String SNIPPET_ID = "Social_Wikis_API_GetMyWikiPages";

    public GetMyWikiPages() {
        setAuthType(AuthType.AUTO_DETECT);
    }

    @Test
    public void testGetMyWikiPages() {
