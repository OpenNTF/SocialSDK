...
***REMOVED*** $wp_list_table->search_box( __( 'Search Comments' ), 'comment' ); ?>

***REMOVED*** if ( $post_id ) : ?>
<input type="hidden" name="p" value="***REMOVED*** echo esc_attr( intval( $post_id ) ); ?>" />
***REMOVED*** endif; ?>
<input type="hidden" name="comment_status" value="***REMOVED*** echo esc_attr($comment_status); ?>" />
<input type="hidden" name="pagegen_timestamp" value="***REMOVED*** echo esc_attr(current_time('mysql', 1)); ?>" />

<input type="hidden" name="_total" value="***REMOVED*** echo esc_attr( $wp_list_table->get_pagination_arg('total_items') ); ?>" />
<input type="hidden" name="_per_page" value="***REMOVED*** echo esc_attr( $wp_list_table->get_pagination_arg('per_page') ); ?>" />
<input type="hidden" name="_page" value="***REMOVED*** echo esc_attr( $wp_list_table->get_pagination_arg('page') ); ?>" />

***REMOVED*** if ( isset($_REQUEST['paged']) ) { ?>
	<input type="hidden" name="paged" value="***REMOVED*** echo esc_attr( absint( $_REQUEST['paged'] ) ); ?>" />
***REMOVED*** } ?>
