		...
		case 'delete-selected':
			...
			<div class="wrap">
				***REMOVED***
				...
				?>
				<div class="error"><p><strong>***REMOVED*** _e( 'Caution:' ); ?></strong> ***REMOVED*** echo _n( 'This theme may be active on other sites in the network.', 'These themes may be active on other sites in the network.', $themes_to_delete ); ?></p></div>
				<p>***REMOVED*** echo _n( 'You are about to remove the following theme:', 'You are about to remove the following themes:', $themes_to_delete ); ?></p>
					<ul class="ul-disc">
						***REMOVED*** foreach ( $theme_info as $theme )
				...
				<p>***REMOVED*** _e('Are you sure you wish to delete these themes?'); ?></p>
				<form method="post" action="***REMOVED*** echo esc_url($_SERVER['REQUEST_URI']); ?>" style="display:inline;">
					...
					***REMOVED***
					...
					?>
					***REMOVED*** wp_nonce_field('bulk-themes') ?>
					***REMOVED*** submit_button( _n( 'Yes, Delete this theme', 'Yes, Delete these themes', $themes_to_delete ), 'button', 'submit', false ); ?>
				</form>
				<form method="post" action="***REMOVED*** echo esc_url(wp_get_referer()); ?>" style="display:inline;">
					***REMOVED*** submit_button( __( 'No, Return me to the theme list' ), 'button', 'submit', false ); ?>
				</form>
...
<div class="wrap">
***REMOVED*** screen_icon('themes'); ?>
<h2>***REMOVED*** echo esc_html( $title ); if ( current_user_can('install_themes') ) { ?> <a href="theme-install.php" class="add-new-h2">***REMOVED*** echo esc_html_x('Add New', 'theme'); ?></a>***REMOVED*** }
if ( $s )
...
***REMOVED*** $wp_list_table->search_box( __( 'Search Installed Themes' ), 'theme' ); ?>
</form>
...
<input type="hidden" name="theme_status" value="***REMOVED*** echo esc_attr($status) ?>" />
