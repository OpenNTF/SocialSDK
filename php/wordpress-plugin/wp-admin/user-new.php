...
***REMOVED*** if ( isset($add_user_errors) && is_wp_error( $add_user_errors ) ) : ?>
	<div class="error">
		***REMOVED***
 ...
 */
?>
<form action="" method="post" name="adduser" id="adduser" class="validate"***REMOVED*** do_action('user_new_form_tag');?>>
<input name="action" type="hidden" value="adduser" />
***REMOVED*** wp_nonce_field( 'add-user', '_wpnonce_add-user' ) ?>

<table class="form-table">
	<tr class="form-field form-required">
		<th scope="row"><label for="adduser-email">***REMOVED*** echo $label; ?></label></th>
		<td><input name="email" type="text" id="adduser-email" class="wp-suggest-user" value="" /></td>
	</tr>
	<tr class="form-field">
		<th scope="row"><label for="adduser-role">***REMOVED*** _e('Role'); ?></label></th>
		<td><select name="role" id="adduser-role">
			***REMOVED*** wp_dropdown_roles( get_option('default_role') ); ?>
			</select>
		</td>
	</tr>
***REMOVED*** if ( is_super_admin() ) { ?>
	<tr>
		<th scope="row"><label for="adduser-noconfirmation">***REMOVED*** _e('Skip Confirmation Email') ?></label></th>
		<td><label for="adduser-noconfirmation"><input type="checkbox" name="noconfirmation" id="adduser-noconfirmation" value="1" /> ***REMOVED*** _e( 'Add the user without sending them a confirmation email.' ); ?></label></td>
	</tr>
***REMOVED*** } ?>
</table>
***REMOVED***
...
?>
***REMOVED*** submit_button( __( 'Add Existing User '), 'primary', 'adduser', true, array( 'id' => 'addusersub' ) ); ?>
</form>
***REMOVED***
} // is_multisite()
...
?>
<p>***REMOVED*** _e('Create a brand new user and add them to this site.'); ?></p>
***REMOVED***
/** This action is documented in wp-admin/user-new.php */
?>
<form action="" method="post" name="createuser" id="createuser" class="validate"***REMOVED*** do_action('user_new_form_tag');?>>
<input name="action" type="hidden" value="createuser" />
***REMOVED*** wp_nonce_field( 'create-user', '_wpnonce_create-user' ); ?>
***REMOVED***
...
<table class="form-table">
	<tr class="form-field form-required">
		<th scope="row"><label for="user_login">***REMOVED*** _e('Username'); ?> <span class="description">***REMOVED*** _e('(required)'); ?></span></label></th>
		<td><input name="user_login" type="text" id="user_login" value="***REMOVED*** echo esc_attr($new_user_login); ?>" aria-required="true" /></td>
	</tr>
	<tr class="form-field form-required">
		<th scope="row"><label for="email">***REMOVED*** _e('E-mail'); ?> <span class="description">***REMOVED*** _e('(required)'); ?></span></label></th>
		<td><input name="email" type="text" id="email" value="***REMOVED*** echo esc_attr($new_user_email); ?>" /></td>
	</tr>
***REMOVED*** if ( !is_multisite() ) { ?>
	<tr class="form-field">
		<th scope="row"><label for="first_name">***REMOVED*** _e('First Name') ?> </label></th>
		<td><input name="first_name" type="text" id="first_name" value="***REMOVED*** echo esc_attr($new_user_firstname); ?>" /></td>
	</tr>
	<tr class="form-field">
		<th scope="row"><label for="last_name">***REMOVED*** _e('Last Name') ?> </label></th>
		<td><input name="last_name" type="text" id="last_name" value="***REMOVED*** echo esc_attr($new_user_lastname); ?>" /></td>
	</tr>
	<tr class="form-field">
		<th scope="row"><label for="url">***REMOVED*** _e('Website') ?></label></th>
		<td><input name="url" type="text" id="url" class="code" value="***REMOVED*** echo esc_attr($new_user_uri); ?>" /></td>
	</tr>
***REMOVED***
/**
...
if ( apply_filters( 'show_password_fields', true ) ) : ?>
	<tr class="form-field form-required">
		<th scope="row"><label for="pass1">***REMOVED*** _e('Password'); ?> <span class="description">***REMOVED*** /* translators: password input field */_e('(required)'); ?></span></label></th>
		<td>
	...
	<tr class="form-field form-required">
		<th scope="row"><label for="pass2">***REMOVED*** _e('Repeat Password'); ?> <span class="description">***REMOVED*** /* translators: password input field */_e('(required)'); ?></span></label></th>
		<td>
	...
	<tr>
		<th scope="row"><label for="send_password">***REMOVED*** _e('Send Password?') ?></label></th>
		<td><label for="send_password"><input type="checkbox" name="send_password" id="send_password" ***REMOVED*** checked( $new_user_send_password ); ?> /> ***REMOVED*** _e('Send this password to the new user by email.'); ?></label></td>
	</tr>
***REMOVED*** endif; ?>
***REMOVED*** } // !is_multisite ?>
	<tr class="form-field">
		<th scope="row"><label for="role">***REMOVED*** _e('Role'); ?></label></th>
	...
	***REMOVED*** if ( is_multisite() && is_super_admin() ) { ?>
	<tr>
		<th scope="row"><label for="noconfirmation">***REMOVED*** _e('Skip Confirmation Email') ?></label></th>
		<td><label for="noconfirmation"><input type="checkbox" name="noconfirmation" id="noconfirmation" value="1" ***REMOVED*** checked( $new_user_ignore_pass ); ?> /> ***REMOVED*** _e( 'Add the user without sending them a confirmation email.' ); ?></label></td>
	</tr>
	***REMOVED*** } ?>
</table>
...
***REMOVED*** submit_button( __( 'Add New User '), 'primary', 'createuser', true, array( 'id' => 'createusersub' ) ); ?>
