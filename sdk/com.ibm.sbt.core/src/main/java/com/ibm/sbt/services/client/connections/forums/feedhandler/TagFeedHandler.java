...
import com.ibm.sbt.services.client.connections.forums.Tag;
import com.ibm.sbt.services.client.connections.forums.TagList;
...
public class TagFeedHandler implements IFeedHandler {
	 ...
	 * @param service
	 */
	public TagFeedHandler(ForumService service){
	...
	public Tag createEntityFromData(Object data) {
		...
		XPathExpression expr = (data instanceof Document) ? (XPathExpression)ForumsXPath.tagEntry.getPath() : null;
