...
// 				$pluginData = $viewData[$plugin];
	...
	<tr>
		...
		<td><input type="text" name="plugin_name" id="plugin_name" value="***REMOVED*** echo (isset($viewData['selected_custom_plugin']) ? $viewData['selected_custom_plugin'] : '') ?>" /></td>
...
<input type="hidden" name="selected_custom_plugin" id="selected_custom_plugin" value="***REMOVED*** echo (isset($viewData['selected_custom_plugin']) ? $viewData['selected_custom_plugin'] : '') ?>" />