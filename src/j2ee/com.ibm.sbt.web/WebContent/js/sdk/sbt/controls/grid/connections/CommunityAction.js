 ...
 * 
 */
define([ "sbt/_bridge/declare", "sbt/controls/grid/GridAction", "dojo/string" ], 
     ...
     */
    declare("sbt.controls.grid.connections.CommunityAction", GridAction, {
    ...
    return sbt.controls.grid.connections.CommunityAction;
});