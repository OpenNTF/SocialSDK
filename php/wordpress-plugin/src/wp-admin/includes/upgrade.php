	...
	foreach ($files as $oldfile => $newfile) {
		...
		if ($lines) {
			...
			foreach ($lines as $line) {
				...
				$line = str_replace("***REMOVED*** echo __get_option('siteurl'); ?>/wp-layout.css", "***REMOVED*** bloginfo('stylesheet_url'); ?>", $line);

				// Update comments template inclusion.
				$line = str_replace("***REMOVED*** include(ABSPATH . 'wp-comments.php'); ?>", "***REMOVED*** comments_template(); ?>", $line);
