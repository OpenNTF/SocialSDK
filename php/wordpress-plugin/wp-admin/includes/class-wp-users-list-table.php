...
class WP_Users_List_Table extends WP_List_Table {
	...
	<div class="alignleft actions">
		***REMOVED*** if ( current_user_can( 'promote_users' ) ) : ?>
		<label class="screen-reader-text" for="new_role">***REMOVED*** _e( 'Change role to&hellip;' ) ?></label>
		<select name="new_role" id="new_role">
			<option value=''>***REMOVED*** _e( 'Change role to&hellip;' ) ?></option>
			***REMOVED*** wp_dropdown_roles(); ?>
		</select>
	***REMOVED***
