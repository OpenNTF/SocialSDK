...
<div id="dialog" title="***REMOVED*** echo $GLOBALS[LANG]['create_new_endpoint'];?>" style="column-width:300px;">
	...
	<button onclick="save_new_endpoint();" id="new_endpoint_save">***REMOVED*** echo $GLOBALS[LANG]['save'];?></button> <button onclick="cancel_new_endpoint();" id="new_endpoint_cancel">***REMOVED*** echo $GLOBALS[LANG]['cancel'];?></button>
</div>