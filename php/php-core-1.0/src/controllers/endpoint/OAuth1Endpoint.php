...
if (file_exists(BASE_PATH . "/core/system/libs/oauth-php/library/OAuthStore.php")) {
	require_once BASE_PATH . "/core/system/libs/oauth-php/library/OAuthStore.php";
} else {
	require_once BASE_PATH . "/system/libs/oauth-php/library/OAuthStore.php";
}
if (file_exists(BASE_PATH . "/core/system/core/SBTKOAuthRequester.php")) {
	require_once BASE_PATH . "/core/system/core/SBTKOAuthRequester.php";
} else {
...
class OAuth1Endpoint extends BaseController
{
	...
	/**
	 * Create a new OAuth 1.0 endpoint
	 *
	...
	public function __construct($config = array())
	{
		...
		OAuthStore::instance("SBTK", $this->options);
	}
