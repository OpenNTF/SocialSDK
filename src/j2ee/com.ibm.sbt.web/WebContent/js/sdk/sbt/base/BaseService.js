...
define(['sbt/_bridge/declare','sbt/config','sbt/lang','sbt/base/core','sbt/xml','sbt/xpath','sbt/Cache','sbt/Endpoint', 'sbt/base/BaseConstants', 
        "sbt/validate", 'sbt/log', 'sbt/stringutil', 'sbt/base/BaseHandler', 'sbt/base/BaseEntity'],
		function(declare,cfg,lang,con,xml,xpath,Cache,Endpoint, BaseConstants, validate, log, stringutil, BaseHandler, BaseEntity) {
