...
public class BaseForumEntityList<T extends BaseForumEntity> extends AtomEntityList<T> {
	
	public BaseForumEntityList(Response requestData, IFeedHandler<T> feedHandler) {
