...
/* <![CDATA[ */
var current_site_id = ***REMOVED*** echo $id; ?>;
/* ]]> */
</script>
...
***REMOVED*** $wp_list_table->search_box( __( 'Search Users' ), 'user' ); ?>
...
***REMOVED*** do_action( 'network_site_users_after_list_table', '' );?>

***REMOVED*** if ( current_user_can( 'promote_users' ) && apply_filters( 'show_network_site_users_add_existing_form', true ) ) : ?>
<h3 id="add-existing-user">***REMOVED*** _e( 'Add Existing User' ); ?></h3>
<form action="site-users.php?action=adduser" id="adduser" method="post">
	<input type="hidden" name="id" value="***REMOVED*** echo esc_attr( $id ) ?>" />
	<table class="form-table">
		<tr>
			<th scope="row">***REMOVED*** _e( 'Username' ); ?></th>
			<td><input type="text" class="regular-text wp-suggest-user" name="newuser" id="newuser" /></td>
		</tr>
		<tr>
			<th scope="row">***REMOVED*** _e( 'Role' ); ?></th>
	...
	***REMOVED*** submit_button( __( 'Add User' ), 'primary', 'add-user', true, array( 'id' => 'submit-add-existing-user' ) ); ?>
</form>
***REMOVED*** endif; ?>

***REMOVED*** if ( current_user_can( 'create_users' ) && apply_filters( 'show_network_site_users_add_new_form', true ) ) : ?>
<h3 id="add-new-user">***REMOVED*** _e( 'Add New User' ); ?></h3>
<form action="***REMOVED*** echo network_admin_url('site-users.php?action=newuser'); ?>" id="newuser" method="post">
	<input type="hidden" name="id" value="***REMOVED*** echo esc_attr( $id ) ?>" />
	<table class="form-table">
		<tr>
			<th scope="row">***REMOVED*** _e( 'Username' ) ?></th>
		...
		<tr>
			<th scope="row">***REMOVED*** _e( 'Email' ) ?></th>
		...
		<tr class="form-field">
			<td colspan="2">***REMOVED*** _e( 'Username and password will be mailed to the above email address.' ) ?></td>
		</tr>
	</table>
	***REMOVED*** wp_nonce_field( 'add-user', '_wpnonce_add-new-user' ) ?>
	***REMOVED*** submit_button( __( 'Add New User' ), 'primary', 'add-user', true, array( 'id' => 'submit-add-user' ) ); ?>
</form>
***REMOVED*** endif; ?>
</div>
***REMOVED***
