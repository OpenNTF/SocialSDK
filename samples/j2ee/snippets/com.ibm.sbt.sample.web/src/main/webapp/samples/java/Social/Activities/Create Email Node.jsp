...
<html>
<head>
	<title>Create Email Node</title>
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
</head>

<body>
	<h4>Create Email Node</h4>
	<div id="content">
	<%
	try {		
		...
		if(activities != null && !activities.isEmpty()) {
			ActivityNode emailNode = new ActivityNode(activityService);
			emailNode.setActivityUuid(activities.get(0).getActivityUuid());
			emailNode.setType(ActivityNode.TYPE_EMAIL);
			emailNode.setTitle("EmailNode from JSP " + System.currentTimeMillis());
			emailNode.setContent("TEXT Content");
			emailNode.setContentType("text");
