 ...
 * @date 25 Mar 2013
 */
public class GetCommunityEvent extends BaseCommunitiesTest {
    
    static final String SNIPPET_ID = "Social_Communities_API_GetCommunityEvent";

    public GetCommunityEvent() {
        setAuthType(AuthType.AUTO_DETECT);
    }

    @Test
    public void testGetCommunityEvent() {
    	Date now = new Date();
    	Date later = new Date(now.getTime() + 360000);
    	//createEvent(community, "Event One", now, later);
    	String eventInstUuid = "";

    	addSnippetParam("CommunityService.eventInstUuid", eventInstUuid);
    ...
    @Test
    public void testGetCommunityEventError() {
        addSnippetParam("CommunityService.eventInstUuid", "Foo");
    ...
    public void testGetCommunityEventsArg() {
        addSnippetParam("CommunityService.eventInstUuid", "");
