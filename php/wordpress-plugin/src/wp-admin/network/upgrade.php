...
switch ( $action ) {
	case "upgrade":
		...
		echo "</ul>";
		?><p>***REMOVED*** _e( 'If your browser doesn&#8217;t start loading the next page automatically, click this link:' ); ?> <a class="button" href="upgrade.php?action=upgrade&amp;n=***REMOVED*** echo ($n + 5) ?>">***REMOVED*** _e("Next Sites"); ?></a></p>
		<script type='text/javascript'>
		<!--
		function nextpage() {
			location.href = "upgrade.php?action=upgrade&n=***REMOVED*** echo ($n + 5) ?>";
		}
	...
	default:
		...
		?>
		<h3>***REMOVED*** _e( 'Database Upgrade Required' ); ?></h3>
		<p>***REMOVED*** _e( 'WordPress has been updated! Before we send you on your way, we need to individually upgrade the sites in your network.' ); ?></p>
		***REMOVED*** endif; ?>

		<p>***REMOVED*** _e( 'The database upgrade process may take a little while, so please be patient.' ); ?></p>
		<p><a class="button" href="upgrade.php?action=upgrade">***REMOVED*** _e( 'Upgrade Network' ); ?></a></p>
		***REMOVED***
