...
***REMOVED*** screen_icon(); ?>
<h2>***REMOVED*** echo esc_html( $title ); ?> <a href="link-add.php" class="add-new-h2">***REMOVED*** echo esc_html_x('Add New', 'link'); ?></a> ***REMOVED***
if ( !empty($_REQUEST['s']) )
...
***REMOVED*** $wp_list_table->search_box( __( 'Search Links' ), 'link' ); ?>
