<div  style="float:left; width:30%;" role="content">
	...
	<div id="success" style="width: 150px; z-index:8000; -webkit-box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.6); -webkit-border-radius: 8px; -moz-box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5); background:#CCC4C4; -moz-border-radius: 6px; color: black; display: none;" class="alert alert-success"></div>
