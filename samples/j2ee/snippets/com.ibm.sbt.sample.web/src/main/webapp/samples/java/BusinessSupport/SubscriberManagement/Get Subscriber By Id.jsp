...
<html>
<head>
<title>Get Subscriber By Id</title>
...
<body>
	...
	try {
		...
		if (!subscriberList.isEmpty()) {
			...
			subscriber = subscriberManagement.getSubscriberById("" + id);
			out.println("<pre>" + subscriber.toJsonString(false) + " <pre/>");
		}
	} catch (Exception e) {
		e.printStackTrace();
		out.println("Error retrieving subscriber by id caused by: "+e.getMessage());    		
	}
	%>
	</div>
</body>
