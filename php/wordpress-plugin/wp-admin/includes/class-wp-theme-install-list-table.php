...
?>
		<div class="tablenav top themes">
			<div class="alignleft actions">
				***REMOVED*** do_action( 'install_themes_table_header' ); ?>
			</div>
			***REMOVED*** $this->pagination( 'top' ); ?>
			<br class="clear" />
		</div>

		<div id="availablethemes">
			***REMOVED*** $this->display_rows_or_placeholder(); ?>
		</div>
	...
	function display_rows() {
		...
		foreach ( $themes as $theme ) {
				?>
				<div class="available-theme installable-theme">***REMOVED***
					$this->single_row( $theme );
				?></div>
		***REMOVED*** } // end foreach $theme_names
	...
	function single_row( $theme ) {
		...
		?>
		<a class="screenshot install-theme-preview" href="***REMOVED*** echo esc_url( $preview_url ); ?>" title="***REMOVED*** echo esc_attr( $preview_title ); ?>">
			<img src='***REMOVED*** echo esc_url( $theme->screenshot_url ); ?>' width='150' />
		</a>

		<h3>***REMOVED*** echo $name; ?></h3>
		<div class="theme-author">***REMOVED*** printf( __( 'By %s' ), $author ); ?></div>

		<div class="action-links">
			<ul>
				***REMOVED*** foreach ( $actions as $action ): ?>
					<li>***REMOVED*** echo $action; ?></li>
				***REMOVED*** endforeach; ?>
				<li class="hide-if-no-js"><a href="#" class="theme-detail">***REMOVED*** _e('Details') ?></a></li>
			</ul>
		</div>
		...
		<div id="theme-installer" class="wp-full-overlay expanded">
			<div class="wp-full-overlay-sidebar">
				<div class="wp-full-overlay-header">
					<a href="#" class="close-full-overlay">***REMOVED*** _e( '&larr; Close' ); ?></a>
				</div>
				<div class="wp-full-overlay-sidebar-content">
					<div class="install-theme-info"></div>
				</div>
				<div class="wp-full-overlay-footer">
					<a href="#" class="collapse-sidebar button-secondary" title="***REMOVED*** esc_attr_e('Collapse Sidebar'); ?>">
						<span class="collapse-sidebar-label">***REMOVED*** _e('Collapse'); ?></span>
	...
	function theme_installer_single( $theme ) {
		...
		<div id="theme-installer" class="wp-full-overlay single-theme">
			<div class="wp-full-overlay-sidebar">
				***REMOVED*** $this->install_theme_info( $theme ); ?>
			</div>
			<div class="wp-full-overlay-main">
				<iframe src="***REMOVED*** echo esc_url( $theme->preview_url ); ?>"></iframe>
			</div>
		</div>
		***REMOVED***
	}
	...
	function install_theme_info( $theme ) {
		...
		?>
		<div class="install-theme-info">***REMOVED***
			switch ( $status ) {
				default:
				case 'install':
			...
			<h3 class="theme-name">***REMOVED*** echo $name; ?></h3>
			<span class="theme-by">***REMOVED*** printf( __( 'By %s' ), $author ); ?></span>
			***REMOVED*** if ( isset( $theme->screenshot_url ) ): ?>
				<img class="theme-screenshot" src="***REMOVED*** echo esc_url( $theme->screenshot_url ); ?>" />
			***REMOVED*** endif; ?>
			<div class="theme-details">
				<div class="star-holder" title="***REMOVED*** echo esc_attr( $num_ratings ); ?>">
					<div class="star-rating" style="width:***REMOVED*** echo esc_attr( intval( $theme->rating ) . 'px' ); ?>;"></div>
				</div>
				<div class="theme-version">
					<strong>***REMOVED*** _e('Version:') ?> </strong>
					***REMOVED*** echo wp_kses( $theme->version, $themes_allowedtags ); ?>
				</div>
				<div class="theme-description">
					***REMOVED*** echo wp_kses( $theme->description, $themes_allowedtags ); ?>
				</div>
			</div>
			<input class="theme-preview-url" type="hidden" value="***REMOVED*** echo esc_url( $theme->preview_url ); ?>" />
		</div>
		***REMOVED***
	}
