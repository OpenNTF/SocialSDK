...
<html>
<head>
<title>SBT JAVA Sample - Get My Sent Notifications</title>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
</head>

<body>
	<h4>Get My Sent Notifications</h4>
	<div id="content">
	<%
		try {
			...
			parameters.put("ps", "5");
			EntityList<Bookmark> bookmarks = svc.getMySentNotifications();
			...
			out.println("<pre>");
			out.println("Problem Occurred while fetching my sent notifications: " + e.getMessage());
