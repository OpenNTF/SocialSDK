...
/**
 * Feed Handler for File Fields
 * @author Vimal Dhupar
 *
 */
public class FileFieldFeedHandler extends FieldFeedHandler implements IFeedHandler {
	 ...
	 * @param service
	 */
	public FileFieldFeedHandler(ActivityService service){
		super(service);
	}
	...
	public Field createEntityFromData(Object data) {
		...
		Field field = new FileField(service, handler);
		return field;
	}
}