...
***REMOVED*** if ( ! empty( $_GET['invalid'] ) ) : ?>
	<div class="error"><p><strong>***REMOVED*** _e('ERROR:')?></strong> ***REMOVED*** printf( __('The <strong>%s</strong> importer is invalid or is not installed.'), esc_html( $_GET['invalid'] ) ); ?></p></div>
***REMOVED*** endif; ?>
<p>***REMOVED*** _e('If you have posts or comments in another system, WordPress can import those into this site. To get started, choose a system to import from below:'); ?></p>
