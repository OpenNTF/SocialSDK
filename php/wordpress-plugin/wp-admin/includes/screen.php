...
final class WP_Screen {
	...
	public function render_screen_meta() {
		...
		<div id="screen-meta" class="metabox-prefs">
			...
			<div id="contextual-help-wrap" class="***REMOVED*** echo esc_attr( $help_class ); ?>" tabindex="-1" aria-label="***REMOVED*** esc_attr_e('Contextual Help Tab'); ?>">
				...
				<div id="contextual-help-columns">
					<div class="contextual-help-tabs">
						...
						***REMOVED***
						...
						foreach ( $this->get_help_tabs() as $tab ) :
							...
							<li id="***REMOVED*** echo esc_attr( $link_id ); ?>"***REMOVED*** echo $class; ?>>
								<a href="***REMOVED*** echo esc_url( "#$panel_id" ); ?>" aria-controls="***REMOVED*** echo esc_attr( $panel_id ); ?>">
									***REMOVED*** echo esc_html( $tab['title'] ); ?>
								</a>
							</li>
						***REMOVED***
							$class = '';
					...
					***REMOVED*** if ( $help_sidebar ) : ?>
					<div class="contextual-help-sidebar">
						***REMOVED*** echo $help_sidebar; ?>
					</div>
					***REMOVED*** endif; ?>
					...
					<div class="contextual-help-tabs-wrap">
						***REMOVED***
						...
						foreach ( $this->get_help_tabs() as $tab ):
							...
							<div id="***REMOVED*** echo esc_attr( $panel_id ); ?>" class="***REMOVED*** echo $classes; ?>">
								***REMOVED***
								// Print tab content.
								echo $tab['content'];
		...
		***REMOVED*** if ( $this->get_help_tabs() ) : ?>
			<div id="contextual-help-link-wrap" class="hide-if-no-js screen-meta-toggle">
			<a href="#contextual-help-wrap" id="contextual-help-link" class="show-settings" aria-controls="contextual-help-wrap" aria-expanded="false">***REMOVED*** _e( 'Help' ); ?></a>
			</div>
		***REMOVED*** endif;
		if ( $this->show_screen_options() ) : ?>
			<div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
			<a href="#screen-options-wrap" id="show-settings-link" class="show-settings" aria-controls="screen-options-wrap" aria-expanded="false">***REMOVED*** _e( 'Screen Options' ); ?></a>
			</div>
		***REMOVED*** endif; ?>
		</div>
		***REMOVED***
	...
	public function render_screen_options() {
		...
		?>
		<div id="screen-options-wrap" class="hidden" tabindex="-1" aria-label="***REMOVED*** esc_attr_e('Screen Options Tab'); ?>">
		<form id="adv-settings" action="" method="post">
		***REMOVED*** if ( isset( $wp_meta_boxes[ $this->id ] ) || $this->get_option( 'per_page' ) || ( $columns && empty( $columns['_title'] ) ) ) : ?>
			<h5>***REMOVED*** _e( 'Show on screen' ); ?></h5>
		***REMOVED***
		endif;
		...
		if ( isset( $wp_meta_boxes[ $this->id ] ) ) : ?>
			...
			***REMOVED*** endif;
			...
			<h5>***REMOVED*** echo $columns['_title']; ?></h5>
			***REMOVED*** endif; ?>
			<div class="metabox-prefs">
				***REMOVED***
		...
		***REMOVED*** endif;
		...
		?>
		<div>***REMOVED*** wp_nonce_field( 'screen-options-nonce', 'screenoptionnonce', false ); ?></div>
		</form>
		</div>
		***REMOVED***
	}
	...
	function render_screen_layout() {
		...
		?>
		<h5 class="screen-layout">***REMOVED*** _e('Screen Layout'); ?></h5>
		<div class='columns-prefs'>***REMOVED***
			_e('Number of Columns:');
			for ( $i = 1; $i <= $num; ++$i ):
				?>
				<label class="columns-prefs-***REMOVED*** echo $i; ?>">
					<input type='radio' name='screen_columns' value='***REMOVED*** echo esc_attr( $i ); ?>'
						***REMOVED*** checked( $screen_layout_columns, $i ); ?> />
	...
	function render_per_page_options() {
		...
		<div class="screen-options">
			***REMOVED*** if ( $per_page_label ) : ?>
				<input type="number" step="1" min="1" max="999" class="screen-per-page" name="wp_screen_options[value]"
					id="***REMOVED*** echo esc_attr( $option ); ?>" maxlength="3"
					value="***REMOVED*** echo esc_attr( $per_page ); ?>" />
				<label for="***REMOVED*** echo esc_attr( $option ); ?>">
					***REMOVED*** echo esc_html( $per_page_label ); ?>
				</label>
			***REMOVED*** endif;

			echo get_submit_button( __( 'Apply' ), 'button', 'screen-options-apply', false ); ?>
			<input type='hidden' name='wp_screen_options[option]' value='***REMOVED*** echo esc_attr($option); ?>' />
		</div>
		***REMOVED***
	}
}
