 ...
 */
package com.ibm.sbt.services.client.connections.files.exception;

/**
 * Files FileServiceException
 * @author Vimal Dhupar
 */
...
public class FileServiceException extends AbstractException {
	    ...
	    public FileServiceException(Throwable nextException, String msg, Object...params) {
