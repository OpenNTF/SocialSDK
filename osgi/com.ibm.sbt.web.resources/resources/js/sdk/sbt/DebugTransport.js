...
dojo.provide('sbt.DebugTransport');
/**
 * Social Business Toolkit SDK. 
 * 
 * Implementation of a transport which writes the response to the DOM.
 */
define('sbt/DebugTransport',[ "sbt/declare", "sbt/lang", "sbt/dom", "sbt/json", "sbt/stringUtil", "sbt/_bridge/Transport" ], function(declare, lang, dom, json, stringUtil, Transport) {
