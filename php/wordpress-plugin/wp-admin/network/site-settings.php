	...
	<table class="form-table">
		***REMOVED***
		...
		foreach ( $options as $option ) {
			...
			?>
				<tr class="form-field">
					<th scope="row">***REMOVED*** echo ucwords( str_replace( "_", " ", $option->option_name ) ) ?></th>
					<td><textarea class="***REMOVED*** echo $class; ?>" rows="5" cols="40" name="option[***REMOVED*** echo esc_attr( $option->option_name ) ?>]" id="***REMOVED*** echo esc_attr( $option->option_name ) ?>"***REMOVED*** disabled( $disabled ) ?>>***REMOVED*** echo esc_textarea( $option->option_value ) ?></textarea></td>
				</tr>
			***REMOVED***
			} else {
			?>
				<tr class="form-field">
					<th scope="row">***REMOVED*** echo esc_html( ucwords( str_replace( "_", " ", $option->option_name ) ) ); ?></th>
					***REMOVED*** if ( $is_main_site && in_array( $option->option_name, array( 'siteurl', 'home' ) ) ) { ?>
					<td><code>***REMOVED*** echo esc_html( $option->option_value ) ?></code></td>
					***REMOVED*** } else { ?>
					<td><input class="***REMOVED*** echo $class; ?>" name="option[***REMOVED*** echo esc_attr( $option->option_name ) ?>]" type="text" id="***REMOVED*** echo esc_attr( $option->option_name ) ?>" value="***REMOVED*** echo esc_attr( $option->option_value ) ?>" size="40" ***REMOVED*** disabled( $disabled ) ?> /></td>
					***REMOVED*** } ?>
				</tr>
			***REMOVED***
			}
