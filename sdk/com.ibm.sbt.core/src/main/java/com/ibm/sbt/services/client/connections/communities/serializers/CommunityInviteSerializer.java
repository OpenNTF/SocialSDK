...
import static com.ibm.sbt.services.client.connections.communities.CommunityConstants.INVITE;
...
public class CommunityInviteSerializer extends AtomEntitySerializer<Invite> {
	...
	protected Element category() {
		return textElement(CATEGORY, "", attribute(COMMUNITY_TERM, INVITE), attribute(Namespace.SCHEME.getPrefix(), Namespace.SCHEME.getUrl()));
	}
