...
define(["../stringUtil", "../Endpoint"], function(stringUtil, Endpoint) {
    ...
    return {
    	 defaultFormat: function (key){
			 return Parameter({key: key, format: Formatter.defaultFormat}); 
		 },
		 
		 sortField: function(key){
			return Parameter({key: key, format: Formatter.sortField}); 
		 },
		 
		 fileSortOrder: function(key){
			 return Paramter({key: key, format: Formatter.sortOrder});
		 },
		 
		 booleanSortOrder: function (key){
			 return Parameter({key: key, format: Formatter.ascSortOrderBoolean});
		 },
