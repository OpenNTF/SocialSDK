 ...
 * <p>
 * The values are mapped by Java objects (String, Number, List<?>, Map<?,?>...). Note that the collections can
 * either be Map or JsonJavaObject.
 * </p>
 * 
 * @ibm-api
 */
public class JsonJavaFactory implements JsonFactory {
	...
	public static final JsonJavaFactory	instanceEx2	= new JsonJavaFactory() {
														...
														public List<Object> createTemporaryArray(Object parent)
																throws JsonException {
															return new JsonJavaArray();
														}

														public Object createArray(Object parent,
																String propertyName, List<Object> values) {
	...
	public boolean isValidValue(Object value) throws JsonException {
		return isNull(value) || isUndefined(value) || isBoolean(value) || isNumber(value) || isString(value)
				|| isObject(value) || isArray(value) || isJavaScriptCode(value);
	}
	...
	public void setProperty(Object parent, String propertyName, Object value) throws JsonException {
		if (parent instanceof Map) {
			...
			throw new IllegalArgumentException(StringUtil.format("Invalid Json object, class: {0}",
					parent != null ? parent.getClass().toString() : "null")); // $NLS-JsonJavaFactory.InvalidJsonobjectclass0-1$
																				// $NON-NLS-2$
		}
	}
	...
	public Object getProperty(Object parent, String propertyName) throws JsonException {
		if (parent instanceof Map) {
			...
			throw new IllegalArgumentException(StringUtil.format("Invalid Json object, class: {0}",
					parent != null ? parent.getClass().toString() : "null")); // $NLS-JsonJavaFactory.InvalidJsonobjectclass0.1-1$
																				// $NON-NLS-2$
		}
	}
	...
	public Iterator<String> iterateObjectProperties(Object object) throws JsonException {
		if (object instanceof Map) {
			...
			throw new IllegalArgumentException(StringUtil.format("Invalid Json object, class: {0}",
					object != null ? object.getClass().toString() : "null")); // $NLS-JsonJavaFactory.InvalidJsonobjectclass0.2-1$
																				// $NON-NLS-2$
		}
	}
