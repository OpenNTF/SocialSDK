...
public class ProfileList extends EntityList<Profile> {
	...
	protected ArrayList<Profile> createEntities() {
		...
		List<JsonJavaObject> entries = dataHandler.getEntries(ProfileJPath.Entry);
	...
	public int getTotalResults() {
		JsonDataHandler dataHandler = new JsonDataHandler(getData());
		return (int) dataHandler.getAsFloat(ProfileJPath.TotalResults);
	}

	@Override
	public int getStartIndex() {
		JsonDataHandler dataHandler = new JsonDataHandler(getData());
		return dataHandler.getAsInt(ProfileJPath.StartIndex);
	}

	@Override
	public int getItemsPerPage() {
		JsonDataHandler dataHandler = new JsonDataHandler(getData());
		return dataHandler.getAsInt(ProfileJPath.ItemsPerPage);
	}
