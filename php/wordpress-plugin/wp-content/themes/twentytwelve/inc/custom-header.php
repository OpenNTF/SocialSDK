...
?>
	...
	#headimg img {
		max-width: ***REMOVED*** echo get_theme_support( 'custom-header', 'max-width' ); ?>px;
	}
	</style>
***REMOVED***
}
...
function twentytwelve_admin_header_image() {
	...
	<div id="headimg">
		***REMOVED***
		...
		?>
		<h1 class="displaying-header-text"><a id="name"***REMOVED*** echo $style; ?> onclick="return false;" href="***REMOVED*** echo esc_url( home_url( '/' ) ); ?>">***REMOVED*** bloginfo( 'name' ); ?></a></h1>
		<h2 id="desc" class="displaying-header-text"***REMOVED*** echo $style; ?>>***REMOVED*** bloginfo( 'description' ); ?></h2>
		***REMOVED*** $header_image = get_header_image();
		if ( ! empty( $header_image ) ) : ?>
			<img src="***REMOVED*** echo esc_url( $header_image ); ?>" class="header-image" width="***REMOVED*** echo get_custom_header()->width; ?>" height="***REMOVED*** echo get_custom_header()->height; ?>" alt="" />
		***REMOVED*** endif; ?>
	</div>
***REMOVED*** }