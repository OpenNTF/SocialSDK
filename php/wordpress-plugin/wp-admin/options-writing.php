...
***REMOVED*** settings_fields('writing'); ?>

<table class="form-table">
<tr valign="top">
<th scope="row">***REMOVED*** _e('Formatting') ?></th>
<td><fieldset><legend class="screen-reader-text"><span>***REMOVED*** _e('Formatting') ?></span></legend>
<label for="use_smilies">
<input name="use_smilies" type="checkbox" id="use_smilies" value="1" ***REMOVED*** checked('1', get_option('use_smilies')); ?> />
***REMOVED*** _e('Convert emoticons like <code>:-)</code> and <code>:-P</code> to graphics on display') ?></label><br />
<label for="use_balanceTags"><input name="use_balanceTags" type="checkbox" id="use_balanceTags" value="1" ***REMOVED*** checked('1', get_option('use_balanceTags')); ?> /> ***REMOVED*** _e('WordPress should correct invalidly nested XHTML automatically') ?></label>
</fieldset></td>
</tr>
<tr valign="top">
<th scope="row"><label for="default_category">***REMOVED*** _e('Default Post Category') ?></label></th>
<td>
***REMOVED***
...
?>
<tr valign="top">
<th scope="row"><label for="default_post_format">***REMOVED*** _e('Default Post Format') ?></label></th>
<td>
	<select name="default_post_format" id="default_post_format">
		<option value="0">***REMOVED*** echo get_post_format_string( 'standard' ); ?></option>
***REMOVED*** foreach ( $post_formats as $format_slug => $format_name ): ?>
		<option***REMOVED*** selected( get_option( 'default_post_format' ), $format_slug ); ?> value="***REMOVED*** echo esc_attr( $format_slug ); ?>">***REMOVED*** echo esc_html( $format_name ); ?></option>
***REMOVED*** endforeach; ?>
	</select>
</td>
</tr>
...
?>
<tr valign="top">
<th scope="row"><label for="default_link_category">***REMOVED*** _e('Default Link Category') ?></label></th>
<td>
***REMOVED***
...
<p>***REMOVED*** _e('Drag-and-drop the following link to your bookmarks bar or right click it and add it to your favorites for a posting shortcut.') ?></p>
...
if ( apply_filters( 'enable_post_by_email_configuration', true ) ) {
?>
<h3 class="title">***REMOVED*** _e('Post via e-mail') ?></h3>
<p>***REMOVED*** printf(__('To post to WordPress by e-mail you must set up a secret e-mail account with POP3 access. Any mail received at this address will be posted, so it&#8217;s a good idea to keep this address very secret. Here are three random strings you could use: <kbd>%s</kbd>, <kbd>%s</kbd>, <kbd>%s</kbd>.'), wp_generate_password(8, false), wp_generate_password(8, false), wp_generate_password(8, false)) ?></p>

<table class="form-table">
<tr valign="top">
<th scope="row"><label for="mailserver_url">***REMOVED*** _e('Mail Server') ?></label></th>
<td><input name="mailserver_url" type="text" id="mailserver_url" value="***REMOVED*** form_option('mailserver_url'); ?>" class="regular-text code" />
<label for="mailserver_port">***REMOVED*** _e('Port') ?></label>
<input name="mailserver_port" type="text" id="mailserver_port" value="***REMOVED*** form_option('mailserver_port'); ?>" class="small-text" />
</td>
</tr>
<tr valign="top">
<th scope="row"><label for="mailserver_login">***REMOVED*** _e('Login Name') ?></label></th>
<td><input name="mailserver_login" type="text" id="mailserver_login" value="***REMOVED*** form_option('mailserver_login'); ?>" class="regular-text ltr" /></td>
</tr>
<tr valign="top">
<th scope="row"><label for="mailserver_pass">***REMOVED*** _e('Password') ?></label></th>
<td>
<input name="mailserver_pass" type="text" id="mailserver_pass" value="***REMOVED*** form_option('mailserver_pass'); ?>" class="regular-text ltr" />
</td>
</tr>
<tr valign="top">
<th scope="row"><label for="default_email_category">***REMOVED*** _e('Default Mail Category') ?></label></th>
<td>
***REMOVED***
...
***REMOVED*** do_settings_fields('writing', 'post_via_email'); ?>
</table>
***REMOVED*** } ?>
...
if ( apply_filters( 'enable_update_services_configuration', true ) ) {
?>
<h3 class="title">***REMOVED*** _e('Update Services') ?></h3>

***REMOVED*** if ( 1 == get_option('blog_public') ) : ?>

<p><label for="ping_sites">***REMOVED*** _e('When you publish a new post, WordPress automatically notifies the following site update services. For more about this, see <a href="http://codex.wordpress.org/Update_Services">Update Services</a> on the Codex. Separate multiple service <abbr title="Universal Resource Locator">URL</abbr>s with line breaks.') ?></label></p>

<textarea name="ping_sites" id="ping_sites" class="large-text code" rows="3">***REMOVED*** echo esc_textarea( get_option('ping_sites') ); ?></textarea>

***REMOVED*** else : ?>

	<p>***REMOVED*** printf(__('WordPress is not notifying any <a href="http://codex.wordpress.org/Update_Services">Update Services</a> because of your site&#8217;s <a href="%s">visibility settings</a>.'), 'options-reading.php'); ?></p>

***REMOVED*** endif; ?>
***REMOVED*** } // multisite ?>

***REMOVED*** do_settings_sections('writing'); ?>
