...
class WP_Themes_List_Table extends WP_List_Table {
	...
	function tablenav( $which = 'top' ) {
		if ( $this->get_pagination_arg( 'total_pages' ) <= 1 )
			return;
		?>
		<div class="tablenav themes ***REMOVED*** echo $which; ?>">
			***REMOVED*** $this->pagination( $which ); ?>
...
?>
		***REMOVED*** $this->tablenav( 'top' ); ?>

		<div id="availablethemes">
			***REMOVED*** $this->display_rows_or_placeholder(); ?>
		</div>

		***REMOVED*** $this->tablenav( 'bottom' ); ?>
***REMOVED***
	}
	...
	function display_rows() {
		...
		foreach ( $themes as $theme ):
			?><div class="available-theme">***REMOVED***
			...
			<a href="***REMOVED*** echo $preview_link; ?>" class="screenshot hide-if-customize">
				***REMOVED*** if ( $screenshot = $theme->get_screenshot() ) : ?>
					<img src="***REMOVED*** echo esc_url( $screenshot ); ?>" alt="" />
				***REMOVED*** endif; ?>
			</a>
			<a href="***REMOVED*** echo wp_customize_url( $stylesheet ); ?>" class="screenshot load-customize hide-if-no-customize">
				***REMOVED*** if ( $screenshot = $theme->get_screenshot() ) : ?>
					<img src="***REMOVED*** echo esc_url( $screenshot ); ?>" alt="" />
				***REMOVED*** endif; ?>
			</a>

			<h3>***REMOVED*** echo $title; ?></h3>
			...
			<div class="action-links">
				...
				***REMOVED*** echo $delete_action; ?>

				***REMOVED*** theme_update_available( $theme ); ?>
			</div>

			<div class="themedetaildiv hide-if-js">
				<p><strong>***REMOVED*** _e('Version: '); ?></strong>***REMOVED*** echo $version; ?></p>
				<p>***REMOVED*** echo $theme->display('Description'); ?></p>
