...
class WP_Admin_Bar {
	...
	final protected function _render( $root ) {
		...
		?>
		<div id="wpadminbar" class="***REMOVED*** echo $class; ?>" role="navigation">
			<a class="screen-reader-shortcut" href="#wp-toolbar" tabindex="1">***REMOVED*** _e('Skip to toolbar'); ?></a>
			<div class="quicklinks" id="wp-toolbar" role="navigation" aria-label="***REMOVED*** esc_attr_e('Top navigation toolbar.'); ?>" tabindex="0">
				***REMOVED*** foreach ( $root->children as $group ) {
					$this->_render_group( $group );
				} ?>
			</div>
			***REMOVED*** if ( is_user_logged_in() ) : ?>
			<a class="screen-reader-shortcut" href="***REMOVED*** echo esc_url( wp_logout_url() ); ?>">***REMOVED*** _e('Log Out'); ?></a>
			***REMOVED*** endif; ?>
		</div>
	...
	final protected function _render_container( $node ) {
		...
		?><div id="***REMOVED*** echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>" class="ab-group-container">***REMOVED***
	...
	final protected function _render_group( $node ) {
		...
		?><ul id="***REMOVED*** echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>"***REMOVED*** echo $class; ?>>***REMOVED***
	...
	final protected function _render_item( $node ) {
		...
		<li id="***REMOVED*** echo esc_attr( 'wp-admin-bar-' . $node->id ); ?>"***REMOVED*** echo $menuclass; ?>>***REMOVED***
			if ( $has_link ):
				?><a class="ab-item" ***REMOVED*** echo $aria_attributes; ?> href="***REMOVED*** echo esc_url( $node->href ) ?>"***REMOVED***
					if ( ! empty( $node->meta['onclick'] ) ) :
						?> onclick="***REMOVED*** echo esc_js( $node->meta['onclick'] ); ?>"***REMOVED***
					endif;
				if ( ! empty( $node->meta['target'] ) ) :
					?> target="***REMOVED*** echo esc_attr( $node->meta['target'] ); ?>"***REMOVED***
				endif;
				if ( ! empty( $node->meta['title'] ) ) :
					?> title="***REMOVED*** echo esc_attr( $node->meta['title'] ); ?>"***REMOVED***
				endif;
				?>>***REMOVED***
			else:
				?><div class="ab-item ab-empty-item" ***REMOVED*** echo $aria_attributes;
				if ( ! empty( $node->meta['title'] ) ) :
					?> title="***REMOVED*** echo esc_attr( $node->meta['title'] ); ?>"***REMOVED***
				endif;
				?>>***REMOVED***
			...
			if ( $is_parent ) :
				?><div class="ab-sub-wrapper">***REMOVED***
					foreach ( $node->children as $group ) {
						$this->_render_group( $group );
					}
				?></div>***REMOVED***
