...
<html>
<head>
<title>Get Subscribers By Email Address</title>
...
<body>
	...
	try {
		...
		if(!subscriberList.isEmpty()){
    		...
    		String email = subscriber.getAsString("Person/EmailAddress");
    		EntityList<JsonEntity> listByEmail = subscriberManagement.getSubscribersByEmail(email);
			out.println("Id's of subscribers by Email Address: " + email + "<br/>");
			out.println("<ul>");
			for (JsonEntity subscr : listByEmail) {
