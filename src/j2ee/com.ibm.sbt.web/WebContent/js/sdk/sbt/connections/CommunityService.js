...
/**
 * The Communities API allows application programs to retrieve community
 * information, subscribe to community updates, and create or modify
 * communities.
 * 
...
define(
		[ "../declare", "../config", "../lang", "../stringUtil", "../Promise",
				"./CommunityConstants", "../base/BaseService",
				"../base/BaseEntity", "../base/XmlDataHandler",
				"./ForumService", "../pathUtil" ],
		function(declare, config, lang, stringUtil, Promise, consts,
				BaseService, BaseEntity, XmlDataHandler, ForumService, pathUtil) {
			...
			/**
			 * Community class represents an entry for a Community feed returned
			 * by the Connections REST API.
			 * 
			 * @class Community
			...
			var Community = declare(BaseEntity, {
				...
				/**
				 * Return the value of IBM Connections community ID from
				...
				/**
				 * Return the value of IBM Connections community title from
				 * community ATOM entry document.
				 * 
				 * @method getTitle
				...
				/**
				 * Return the community type of the IBM Connections community
				...
				/**
				 * Return the community theme of the IBM Connections community
				 * from community ATOM entry document.
				 * 
				...
				/**
				 * Return the value of IBM Connections community description
				 * from community ATOM entry document.
				 * 
				 * @method getContent
				...
				/**
				 * Return tags of IBM Connections community from community ATOM
				 * entry document.
				 * 
				 * @method getTags
				...
				/**
				 * Set new tags to be associated with this IBM Connections
				 * community.
				 * 
				 * @method setTags
				 * @param {Object}
				...
				/**
				 * Return the value of IBM Connections community description
				 * summary from community ATOM entry document.
				 * 
				 * @method getSummary
				 * @return {String} Community description summary of the
				 *         community
				 */
				getSummary : function() {
				...
				/**
				 * Return the value of IBM Connections community URL from
				 * community ATOM entry document.
				 * 
				...
				/**
				 * Return the value of IBM Connections community Logo URL from
				 * community ATOM entry document.
				 * 
				 * @method getLogoUrl
				...
				/**
				 * Return the published date of the IBM Connections community
				 * from community ATOM entry document.
				 * 
				 * @method getPublished
				...
				/**
				 * Return the last updated date of the IBM Connections community
				 * from community ATOM entry document.
				 * 
				 * @method getUpdated
				...
				/**
				 * Get a list for forum topics that includes the topics in this
				 * community.
				 * 
				...
				getForumTopics : function(args) {
					return this.service.getForumTopics(this.getCommunityUuid(),
							args);
				},

				/**
				 * Create a forum topc by sending an Atom entry document
				 * containing the new forum to the forum replies resource.
				 * 
				 * @method createForumTopic
				 * @param {Object}
				 *            forumTopic Forum topic object which denotes the
				 *            forum topic to be created.
				 * @param {Object}
				 *            [args] Argument object
				 */
				createForumTopic : function(communityUuid, topicOrJson, args) {
					return this.service.createForumTopic(this
							.getCommunityUuid(), topicOrJson, args);
				},
				 ...
				 * @param {Object}
				 *            [args] Object representing various parameters that
				 *            can be passed to get a feed of members of a
				 *            community. The parameters must be exactly as they
				 *            are supported by IBM Connections like ps, sortBy
				 *            etc.
				 */
				getSubCommunities : function(args) {
					return this.service.getSubCommunities(this
							.getCommunityUuid(), args);
				},
				...
				getMembers : function(args) {
					return this.service.getMembers(this.getCommunityUuid(),
							args);
				},
				 ...
				 *            [args] Argument object
				 * @param {Object}
				 *            [args.member] Object representing the member to be
				 *            added
				 * @param {String}
				 *            [args.email] Object representing the email of the
				 *            memeber to be added
				 * @param {String}
				 *            [args.id] String representing the id of the member
				 *            to be added
				 */
				addMember : function(member, args) {
					return this.service.addMember(this.getCommunityUuid(),
							member, args);
				},
				...
				removeMember : function(memberId, args) {
					return this.service.removeMember(this.getCommunityUuid(),
							memberId, args);
				},

				/**
				 * Loads a member object with the atom entry associated with the
				 * member of the community. By default, a network call is made
				 * to load the atom entry document in the member object.
				 * 
				 * @method getMember
				 * @param {String}
				 *            member id of the member.
				...
				getMember : function(memberId, args) {
					return this.service.getMember(this.getCommunityUuid(),
							memberId, args);
				},

				/**
				 * Loads the community object with the atom entry associated
				 * with the community. By default, a network call is made to
				 * load the atom entry document in the community object.
				 * 
				 * @method load
				 * @param {Object}
				 *            [args] Argument object
				...
				load : function(args) {
					...
					var promise = this.service
							._validateCommunityUuid(communityUuid);
					if (promise) {
						return promise;
					}
					...
					return this.service.getEntity(consts.AtomCommunityInstance,
							options, communityUuid, callbacks);
				},
				...
				remove : function(args) {
					return this.service.deleteCommunity(
							this.getCommunityUuid(), args);
				},
				...
				getForums : function(args) {
					...
					var requestArgs = lang.mixin(args || {}, {
						communityUuid : this.getCommunityUuid()
					});
			...
			/**
			 * Member class represents an entry for a Member feed returned by
			...
			var Member = declare(BaseEntity, {
				...
				/**
				 * Return the value of community member role from community
				 * member ATOM entry document.
				 * 
				 * @method getRole
				...
				/**
				 * Loads the member object with the atom entry associated with
				 * the member. By default, a network call is made to load the
				 * atom entry document in the member object.
				 * 
				 * @method load
				 * @param {Object}
				 *            [args] Argument object
				...
				load : function(args) {
					...
					return this.service.getEntity(consts.AtomCommunityMembers,
							options, memberId, callbacks);
				},
			...
			/**
			 * Invite class represents an entry for a Invite feed returned by
			 * the Connections REST API.
			 * 
			 * @class Invite
			 * @namespace sbt.connections
			...
			/**
			 * Event class represents an entry for an Events feed returned by
			 * the Connections REST API.
			 * 
			 * @class Event
			 * @namespace sbt.connections
			...
			var Event = declare(BaseEntity, {
				...
				/**
				 * The Uuid of the event. This is per event rather than per
				 * event instance.
				 * 
				 * e.g. if an event spans multiple days it will have multiple
				 * instances, yet each even will have the same Uuid.
				 * 
				 * @method getEventUuid
				...
				/**
				 * The event instance uuid. This is per event instance, rather
				 * than per event. e.g. if an event spans multiple days each day
				 * will have its own eventInstUuid.
				 * 
				 * Can be used with the{{#crossLink
				 * "CommunityService/getEvent:method"}}{{/crossLink}} method to
				 ...
				 * 
				 * Recurrence information object consists of: frequency -
				 * 'daily' or 'weekly' interval - Week interval. Value is int
				 * between 1 and 5. until - The end date of the repeating event.
				 * allDay - 1 if an all day event, 0 otherwise. startDate -
				 * Start time of the event endDate - End time of the event byDay -
				 * Days of the week this event occurs, possible values are:
				 * SU,MO,TU,WE,TH,FR,SA
				 * 
				 * @method getRecurrence
				 * @return {Object} An object containing the above recurrence
				 *         information of the community event.
				 */
			...
			/*
			 * Callbacks used when reading a feed that contains Community
			 * entries.
			 */
			...
			var CommunityService = declare(
					BaseService,
					{
						...
						/**
						 * Get the All Communities feed to see a list of all
						 * public communities to which the authenticated user
						 * has access or pass in parameters to search for
						 * communities that match a specific criteria.
						 * 
						 * @method getPublicCommunities
						 * 
						 * @param {Object}
						 *            [args] Object representing various
						 *            parameters that can be passed to get a
						 *            feed of my communities. The parameters
						 *            must be exactly as they are supported by
						 *            IBM Connections like ps, sortBy etc.
						 */
						getPublicCommunities : function(args) {
							...
							return this.getEntities(consts.AtomCommunitiesAll,
									options, this.getCommunityFeedCallbacks());
						},

						/**
						 * Get the My Communities feed to see a list of the
						 * communities to which the authenticated user is a
						 * member or pass in parameters to search for a subset
						...
						getMyCommunities : function(args) {
							...
							return this.getEntities(consts.AtomCommunitiesMy,
									options, this.getCommunityFeedCallbacks());
						},

						/**
						 * Retrieve the members feed to view a list of the
						 * members who belong to a given community.
						 * 
						 * @method getMembers
						 * @param {Object}
						 *            [args] Object representing various
						 *            parameters that can be passed to get a
						 *            feed of members of a community. The
						 *            parameters must be exactly as they are
						 *            supported by IBM Connections like ps,
						 *            sortBy etc.
						 */
						getMembers : function(communityUuid, args) {
							...
							var callbacks = this
									.getMemberFeedCallbacks(communityUuid);

							return this.getEntities(
									consts.AtomCommunityMembers, options,
									callbacks);
						},

						/**
						 * Retrieve the member entry to view a member who
						 * belongs to a given community.
						 * 
						 * @method getMembers
						 * @param {Object}
						 *            [args] Object representing various
						...
						/**
						 * Get the Events for a community. See {{#crossLink
						 * "CommunityConstants/AtomCommunityEvents:attribute"}}{{/crossLink}}
						 * for a complete listing of parameters.
						 * 
						 * These results do not include all details of the
						 * event, such as content. However summaries are
						 * available.
						 * 
						 * @param communityId
						 *            The uuid of the Community.
						 * @param startDate
						 *            Include events that end after this date.
						 * @param endDate
						 *            Include events that end before this date.
						 * @param args
						 *            url parameters.
						 * 
						 * @returns
						 */
						getCommunityEvents : function(communityUuid, startDate,
								endDate, args) {
							var promise = this
									._validateCommunityUuid(communityUuid)
									|| this._validateDateTimes(startDate,
											endDate);
							if (promise) {
								return promise;
							}
							...
							return this.getEntities(consts.AtomCommunityEvents,
									options, this.getEventFeedCallbacks());
						},

						/**
						 * Used to get the event with the given eventInstUuid.
						 * 
						 * This will include all details of the event, including
						 * its content.
						 * 
						 * @param eventInstUuid -
						 *            The id of the event, also used as an
						 *            identifier when caching the response
						 * @returns
						 */
						getEvent : function(eventInstUuid) {
							...
							return this.getEntity(consts.AtomCommunityEvent,
									options, eventInstUuid, this
											.getEventCallbacks());
						},

						/**
						 * Get a list of the outstanding community invitations
						 * of the currently authenticated user or provide
						 * parameters to search for a subset of those
						 * invitations.
						 * 
						 * @method getMyInvites
						 * @param {Object}
						...
						getMyInvites : function(args) {
							...
							return this.getEntities(
									consts.AtomCommunityInvitesMy, options,
									this.getInviteFeedCallbacks());
						},

						/**
						 * Get a list of subcommunities associated with a
						 * community.
						 * 
						 * @method getSubCommunities
						 * @param {Object}
						...
						getSubCommunities : function(communityUuid, args) {
							...
							return this.getEntities(
									consts.AtomCommunitySubCommunities,
									options, this.getCommunityFeedCallbacks());
						},

						/**
						 * Get a list for forum topics for th specified
						 * community.
						 * 
						 * @method getForumTopics
						 * @param communityUuid
						...
						getForumTopics : function(communityUuid, args) {
							...
							return this.getEntities(
									consts.AtomCommunityForumTopics, options,
									this.getForumTopicFeedCallbacks());
						},

						/**
						 * Decline an invite to be a member of a community,
						 * using the HTTP DELETE method.
						 * 
						 * @method declineInvite
						 * @param {String}
						 *            communityUuid community id of the
						 *            community whose invite is to be declined.
						 * @param {String}
						 *            contributorId userId/email of the logged
						 *            in user who is declining the invite.
						 * @param {Object}
						 *            [args] Argument object
						 */

						declineInvite : function(communityUuid, contributorId,
								args) {
							var promise = this
									._validateCommunityUuid(communityUuid);
							if (promise) {
							...
							var key = this.isEmail(contributorId) ? "email"
									: "userid";
							...
							return this.deleteEntity(
									consts.AtomCommunityInvites, options,
									communityUuid);

						},

						/**
						 * Accept an invite to be a member of a community, using
						 * the HTTP POST method.
						 * 
						 * @method acceptInvite
						 * @param {String}
						 *            communityUuid community id of the
						 *            community whose invite is to be accepted.
						 * @param {String}
						 *            contributorId userId/email of the logged
						 *            in user who is accepting the invite.
						 * @param {Object}
						 *            [args] Argument object
						 */

						acceptInvite : function(communityUuid, contributorId,
								args) {
							var promise = this
									._validateCommunityUuid(communityUuid);
							if (promise) {
							...
							var options = {
								...
								data : this
										._constructAcceptInvitePostData(contributorId)
							};
							// return the community id for the community whose
							// invite is accepted in the argument of the success
							// promise.
							var callbacks = {};
							callbacks.createEntity = function(service, data,
									response) {
						...
						/**
						 * Create an invite to be a member of a community, using
						 * the HTTP POST method.
						 * 
						 * @method createInvite
						 * @param {String}
						 *            communityUuid community id of the
						 *            community for which invite is to be
						 *            created.
						 * @param {String}
						 *            contributorId userId/email of the user who
						 *            is invited to be the member of the
						 *            community.
						 * @param {Object}
						 *            [args] Argument object
						 */

						createInvite : function(communityUuid, contributorId,
								args) {
							var promise = this
									._validateCommunityUuid(communityUuid);
							if (promise) {
							...
							var options = {
								...
								headers : consts.AtomXmlHeaders,
								data : this
										._constructCreateInvitePostData(contributorId)
							};
							// return the community id for the community whose
							// invite is accepted in the argument of the success
							// promise.
						...
						/**
						 * Create a forum topc by sending an Atom entry document
						 * containing the new forum to the forum replies
						 * resource.
						 * 
						 * @method createForumTopic
						 * @param {String}
						 *            communityUuid Community UUID of the
						 *            community for this forum topic
						 * @param {Object}
						 *            forumTopic Forum topic object which
						 *            denotes the forum topic to be created.
						 * @param {Object}
						 *            [args] Argument object
						 */
						createForumTopic : function(communityUuid, topicOrJson,
								args) {
							var promise = this
									._validateCommunityUuid(communityUuid);
							if (promise) {
							...
							var forumTopic = forumService
									.newForumTopic(topicOrJson);
							var promise = forumService._validateForumTopic(
									forumTopic, false, args);
							if (promise) {
								return promise;
							}
							...
							callbacks.createEntity = function(service, data,
									response) {
								var topicUuid = this.getLocationParameter(
										response, "topicUuid");
						...
						/**
						 * Retrieve a community entry, use the edit link for the
						 * community entry which can be found in the my
						 * communities feed.
						 * 
						 * @method getCommunity
						 * @param {String }
						 *            communityUuid
						 * @param {Object}
						 *            args Object containing the query arguments
						 *            to be sent (defined in IBM Connections
						...
						/**
						 * Create a community by sending an Atom entry document
						 * containing the new community to the My Communities
						 * resource.
						 * 
						 * @method createCommunity
						 * @param {Object}
						 *            community Community object which denotes
						 *            the community to be created.
						 * @param {Object}
						 *            [args] Argument object
						 */
						createCommunity : function(communityOrJson, args) {
							var community = this._toCommunity(communityOrJson);
							var promise = this._validateCommunity(community,
									false, args);
							if (promise) {
								return promise;
							}
							...
							callbacks.createEntity = function(service, data,
									response) {
								var communityUuid = this.getLocationParameter(
										response, "communityUuid");
							...
							var options = {
								...
								headers : consts.AtomXmlHeaders,
								data : this
										._constructCommunityPostData(community)
							};

							return this.updateEntity(consts.AtomCommunitiesMy,
									options, callbacks, args);
						},

						/**
						 * Update a community by sending a replacement community
						 * entry document in Atom format to the existing
						 * community's edit web address. All existing community
						 * entry information will be replaced with the new data.
						 * To avoid deleting all existing data, retrieve any
						 * data you want to retain first, and send it back with
						 * this request. For example, if you want to add a new
						 * tag to a community entry, retrieve the existing tags,
						 * and send them all back with the new tag in the update
						 * request.
						 * 
						...
						updateCommunity : function(communityOrJson, args) {
							...
							return this.updateEntity(
									consts.AtomCommunityInstance, options,
									callbacks, args);
						},

						/**
						 * Delete a community, use the HTTP DELETE method. Only
						 * the owner of a community can delete it. Deleted
						 * communities cannot be restored
						 * 
						 * @method deleteCommunity
						 * @param {String/Object}
						 *            community id of the community or the
						 *            community object (of the community to be
						 *            deleted)
						 * @param {Object}
						 *            [args] Argument object
						 */
						 ...
						 *            community object.
						 * @param {Object}
						 *            member member object representing the
						 *            member of the community to be added
						 * @param {Object}
						 *            [args] Argument object
						 */
						addMember : function(communityUuid, memberOrId, args) {
							...
							callbacks.createEntity = function(service, data,
									response) {
								var userid = this.getLocationParameter(
										response, "userid");
						...
						/**
						 * Updates a member in the access control list for an
						 * application, sends a replacement member entry
						 * document in Atom format to the existing ACL node's
						 * edit web address.
						 * 
						 * @method updateMember
						 * @param {String}
						 ...
						 *            memberOrJson
						 */
						updateMember : function(communityUuid, memberOrJson,
								args) {
							var promise = this.validateField("memberOrJson",
									memberOrJson);
							if (!promise) {
								promise = this.validateField("communityUuid",
										communityUuid);
							}
							if (promise) {
								return promise;
							...
							var value = member.getEmail() ? member.getEmail()
									: member.getUserid();
						...
						removeMember : function(communityUuid, memberId, args) {
							...
							return this
									.deleteEntity(consts.AtomCommunityMembers,
											options, value);
						},
						 ...
						 * @param {Object}
						 *            fileControlOrId The Id of html control or
						 *            the html control
						 * @param {String}
						 *            communityUuid the Uuid of community
						 */
						updateCommunityLogo : function(fileControlOrId,
								communityUuid) {
							var promise = this.validateField(
									"File Control Or Id", fileControlOrId);
							if (promise) {
								return promise;
							}
							...
							var fileControl = this
									.getFileControl(fileControlOrId);
							if (!fileControl) {
								return this
										.createBadRequestPromise("File Control or ID is required");
							}
							...
							if (files.length != 1) {
								return this
										.createBadRequestPromise("Only one file needs to be provided to this API");
							}
							...
							var url = this
									.constructUrl(
											consts.AtomUpdateCommunityLogo,
											null,
											{
							...
							if (this.endpoint.proxy) {
								...
								return this
										.createBadRequestPromise("File Proxy is required to run this API");
							}

							var headers = {
								"Content-Type" : false,
								"Process-Data" : false
							// processData = false is reaquired by jquery
							};
							var options = {
								method : "PUT",
								headers : headers,
							...
							var callbacks = {
								createEntity : function(service, data, response) {
									return data; // Since this API does not
													// return any response in
													// case of success,
						...
						/*
						 * Callbacks used when reading an entry that contains a
						 * Community.
						 */
						...
						/*
						 * Return a Community instance from Community or JSON or
						 * String. Throws an error if the argument was neither.
						 */
						...
						/*
						 * Return a Community UUID from Community or
						 * communityUuid. Throws an error if the argument was
						 * neither or is invalid.
						 */
						...
						/*
						 * Return a Community Member from Member or memberId.
						 * Throws an error if the argument was neither or is
						 * invalid.
						 */
						_toMember : function(idOrJson) {
							if (idOrJson) {
								...
								if (lang.isString(idOrJson)) {
									...
									if (idOrJson.id && !idOrJson.userid
											&& !idOrJson.email) {
										this.isEmail(idOrJson.id) ? idOrJson.email = idOrJson.id
												: idOrJson.userid = idOrJson.id;
										delete idOrJson.id;
									}
						...
						/*
						 * Validate a community UUID, and return a Promise if
						 * invalid.
						 */
						_validateCommunityUuid : function(communityUuid) {
							if (!communityUuid || communityUuid.length == 0) {
								return this
										.createBadRequestPromise("Invalid argument, expected communityUuid.");
							}
						},
						/**
						 * Validate that the date-time is not empty, return a
						 * promise if invalid
						 */
						_validateDateTimes : function(startDate, endDate) {
							if ((!startDate || startDate.length === 0)
								...
								return this
										.createBadRequestPromise("Invalid date arguments, expected either a startDate, endDate or both as parameters.");
							}
						},
						...
						_validateContributorId : function(contributorId) {
							if (!contributorId || contributorId.length == 0) {
								return this
										.createBadRequestPromise("Invalid argument, expected contributorId.");
							}
						},

						/*
						 * Validate a community, and return a Promise if
						 * invalid.
						 */
						_validateCommunity : function(community, checkUuid) {
							if (!community || !community.getTitle()) {
								return this
										.createBadRequestPromise("Invalid argument, community with title must be specified.");
							}
							if (checkUuid && !community.getCommunityUuid()) {
								return this
										.createBadRequestPromise("Invalid argument, community with UUID must be specified.");
							}
						},
						...
						_validateMember : function(member, args) {
							if (!member
									|| (!member.getUserid() && !member
											.getEmail())) {
								return this
										.createBadRequestPromise("Invalid argument, member with userid or email must be specified.");
							}
						},
						...
						_constructCommunityPostData : function(community) {
							var transformer = function(value, key) {
								if (key == "getTags") {
									...
									value = stringUtil.transform(
											CommunityThemeTmpl, {
												"communityTheme" : value
											});
								}
								return value;
							};

							var postData = stringUtil.transform(CommunityTmpl,
									community, transformer, community);
						...
						_constructMemberPostData : function(member) {
							...
							return stringUtil.transform(MemberTmpl, member,
									transformer, member);
						},
						/*
						...
						_constructCreateInvitePostData : function(contributorId) {
							var isEmail = this.isEmail(contributorId) ? true
									: false;
							var contributorMap = {};
							if (isEmail) {
							...
							var transformer = function(value, key) {
								...
								if (key == "getEmail") {
									if (isEmail) {
										if (value) {
											returnVal = stringUtil.transform(
													EmailTmpl, {
														"email" : value
													});
										}
							...
							return stringUtil.transform(CreateInviteTmpl,
									contributorMap, transformer, null);
						},
						/*
						...
						_constructAcceptInvitePostData : function(contributorId) {
							...
							return stringUtil.transform(AcceptInviteTmpl,
									contributorMap, transformer, null);
						}
					});
