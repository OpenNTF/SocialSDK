...
<body>
	...
	<%
		try {
			...
			EntityList<CMISFile> files = fileService.getMyFiles(); 
			if(files != null && ! files.isEmpty()) {
				out.println("List of My Files<br>");
				for (CMISFile file : files) {
					out.println("<br>Name = " + file.getCmisName());
					out.println(", Id = " + file.getId());
					out.println(", <a href=\"" + file.getDownloadUrl() + "\"> " + file.getCmisName() + "</a><br/>" );
				}
			} else {
