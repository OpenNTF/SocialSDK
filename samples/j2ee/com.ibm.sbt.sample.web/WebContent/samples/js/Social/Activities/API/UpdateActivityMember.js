require([ "sbt/dom", "sbt/json", "sbt/connections/ActivityService" ], function(dom,json,ActivityService) {
        ...
        var member = activitiesService.newMember({     
        	"id" : "%{name=sample.memberId|helpSnippetId=Social_Activities_API_AddMemberToActivity}",
        	"userId" : "%{name=sample.userId2|helpSnippetId=Social_Activities_API_AddMemberToActivity}",
        	"role" : "reader",
        	"category" : "person"
        });
