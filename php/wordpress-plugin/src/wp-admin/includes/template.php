...
function wp_popular_terms_checklist( $taxonomy, $default = 0, $number = 10, $echo = true ) {
	...
	foreach ( (array) $terms as $term ) {
		...
		<li id="***REMOVED*** echo $id; ?>" class="popular-category">
			<label class="selectit">
			<input id="in-***REMOVED*** echo $id; ?>" type="checkbox" ***REMOVED*** echo $checked; ?> value="***REMOVED*** echo (int) $term->term_id; ?>" ***REMOVED*** disabled( ! current_user_can( $tax->cap->assign_terms ) ); ?> />
				***REMOVED*** echo esc_html( apply_filters( 'the_category', $term->name ) ); ?>
			</label>
		</li>
...
***REMOVED*** if ( $table_row ) : ?>
<table style="display:none;"><tbody id="com-reply"><tr id="replyrow" style="display:none;"><td colspan="***REMOVED*** echo $wp_list_table->get_column_count(); ?>" class="colspanchange">
***REMOVED*** else : ?>
<div id="com-reply" style="display:none;"><div id="replyrow" style="display:none;">
***REMOVED*** endif; ?>
	<div id="replyhead" style="display:none;"><h5>***REMOVED*** _e( 'Reply to Comment' ); ?></h5></div>
	<div id="addhead" style="display:none;"><h5>***REMOVED*** _e('Add new Comment'); ?></h5></div>
	<div id="edithead" style="display:none;">
		...
		<div class="inside">
		<label for="author-email">***REMOVED*** _e('E-mail') ?></label>
		<input type="text" name="newcomment_author_email" size="50" value="" id="author-email" />
		</div>

		<div class="inside">
		<label for="author-url">***REMOVED*** _e('URL') ?></label>
	...
	***REMOVED***
	...
	<span id="addbtn" style="display:none;">***REMOVED*** _e('Add Comment'); ?></span>
	<span id="savebtn" style="display:none;">***REMOVED*** _e('Update Comment'); ?></span>
	<span id="replybtn" style="display:none;">***REMOVED*** _e('Submit Reply'); ?></span></a>
	<a href="#comments-form" class="cancel button-secondary alignleft">***REMOVED*** _e('Cancel'); ?></a>
	<span class="waiting spinner"></span>
	<span class="error" style="display:none;"></span>
	<br class="clear" />
	</p>

	<input type="hidden" name="user_ID" id="user_ID" value="***REMOVED*** echo get_current_user_id(); ?>" />
	<input type="hidden" name="action" id="action" value="" />
	<input type="hidden" name="comment_ID" id="comment_ID" value="" />
	<input type="hidden" name="comment_post_ID" id="comment_post_ID" value="" />
	<input type="hidden" name="status" id="status" value="" />
	<input type="hidden" name="position" id="position" value="***REMOVED*** echo $position; ?>" />
	<input type="hidden" name="checkbox" id="checkbox" value="***REMOVED*** echo $checkbox ? 1 : 0; ?>" />
	<input type="hidden" name="mode" id="mode" value="***REMOVED*** echo esc_attr($mode); ?>" />
	***REMOVED***
...
<div class="hidden" id="trash-undo-holder">
	<div class="trash-undo-inside">***REMOVED*** printf(__('Comment by %s moved to the trash.'), '<strong></strong>'); ?> <span class="undo untrash"><a href="#">***REMOVED*** _e('Undo'); ?></a></span></div>
</div>
<div class="hidden" id="spam-undo-holder">
	<div class="spam-undo-inside">***REMOVED*** printf(__('Comment by %s marked as spam.'), '<strong></strong>'); ?> <span class="undo unspam"><a href="#">***REMOVED*** _e('Undo'); ?></a></span></div>
</div>
***REMOVED***
}
...
<table id="list-table">
	<thead>
	<tr>
		<th class="left">***REMOVED*** _ex( 'Name', 'meta name' ) ?></th>
		<th>***REMOVED*** _e( 'Value' ) ?></th>
	</tr>
	</thead>
	<tbody id='the-list' data-wp-lists='list:meta'>
***REMOVED***
...
function meta_form( $post = null ) {
	...
	if ( $keys )
		natcasesort($keys);
?>
<p><strong>***REMOVED*** _e( 'Add New Custom Field:' ) ?></strong></p>
<table id="newmeta">
<thead>
<tr>
<th class="left"><label for="metakeyselect">***REMOVED*** _ex( 'Name', 'meta name' ) ?></label></th>
<th><label for="metavalue">***REMOVED*** _e( 'Value' ) ?></label></th>
</tr>
</thead>
...
<option value="#NONE#">***REMOVED*** _e( '&mdash; Select &mdash;' ); ?></option>
***REMOVED***
...
<span id="enternew">***REMOVED*** _e('Enter new'); ?></span>
<span id="cancelnew" class="hidden">***REMOVED*** _e('Cancel'); ?></span></a>
***REMOVED*** } else { ?>
...
<tr><td colspan="2">
<div class="submit">
***REMOVED*** submit_button( __( 'Add Custom Field' ), 'secondary', 'addmeta', false, array( 'id' => 'newmeta-submit', 'data-wp-lists' => 'add:the-list:newmeta' ) ); ?>
</div>
***REMOVED*** wp_nonce_field( 'add-meta', '_ajax_nonce-add-meta', false ); ?>
</td></tr>
</tbody>
</table>
***REMOVED***
...
<p>
<a href="#edit_timestamp" class="save-timestamp hide-if-no-js button">***REMOVED*** _e('OK'); ?></a>
<a href="#edit_timestamp" class="cancel-timestamp hide-if-no-js">***REMOVED*** _e('Cancel'); ?></a>
</p>
***REMOVED***
}
...
function wp_import_upload_form( $action ) {
	...
	if ( ! empty( $upload_dir['error'] ) ) :
		?><div class="error"><p>***REMOVED*** _e('Before you can upload your import file, you will need to fix the following error:'); ?></p>
		<p><strong>***REMOVED*** echo $upload_dir['error']; ?></strong></p></div>***REMOVED***
	else :
?>
<form enctype="multipart/form-data" id="import-upload-form" method="post" class="wp-upload-form" action="***REMOVED*** echo esc_url( wp_nonce_url( $action, 'import-upload' ) ); ?>">
<p>
<label for="upload">***REMOVED*** _e( 'Choose a file from your computer:' ); ?></label> (***REMOVED*** printf( __('Maximum size: %s' ), $size ); ?>)
<input type="file" id="upload" name="import" size="25" />
<input type="hidden" name="action" value="save" />
<input type="hidden" name="max_file_size" value="***REMOVED*** echo $bytes; ?>" />
</p>
***REMOVED*** submit_button( __('Upload file and import'), 'button' ); ?>
</form>
***REMOVED***
	endif;
}
		...
		foreach ( array( 'high', 'core', 'default', 'low' ) as $priority ) {
			if ( isset( $wp_meta_boxes[$page][$context][$priority] ) ) {
				foreach ( $wp_meta_boxes[$page][$context][$priority] as $box ) {
					...
					?>
					<li class="control-section accordion-section ***REMOVED*** echo $hidden_class; ?> ***REMOVED*** echo $open_class; ?> ***REMOVED*** echo esc_attr( $box['id'] ); ?>" id="***REMOVED*** echo esc_attr( $box['id'] ); ?>">
						<h3 class="accordion-section-title hndle" tabindex="0" title="***REMOVED*** echo esc_attr( $box['title'] ); ?>">***REMOVED*** echo esc_html( $box['title'] ); ?></h3>
						<div class="accordion-section-content ***REMOVED*** postbox_classes( $box['id'], $page ); ?>">
							<div class="inside">
								***REMOVED*** call_user_func( $box['callback'], $object, $box ); ?>
							</div><!-- .inside -->
...
?>
	<div id="find-posts" class="find-box" style="display:none;">
		<div id="find-posts-head" class="find-box-head">***REMOVED*** _e('Find Posts or Pages'); ?></div>
		<div class="find-box-inside">
			<div class="find-box-search">
				***REMOVED*** if ( $found_action ) { ?>
					<input type="hidden" name="found_action" value="***REMOVED*** echo esc_attr($found_action); ?>" />
				***REMOVED*** } ?>

				<input type="hidden" name="affected" id="affected" value="" />
				***REMOVED*** wp_nonce_field( 'find-posts', '_ajax_nonce', false ); ?>
				<label class="screen-reader-text" for="find-posts-input">***REMOVED*** _e( 'Search' ); ?></label>
				<input type="text" id="find-posts-input" name="ps" value="" />
				<span class="spinner"></span>
				<input type="button" id="find-posts-search" value="***REMOVED*** esc_attr_e( 'Search' ); ?>" class="button" />
			</div>
			<div id="find-posts-response"></div>
		</div>
		<div class="find-box-buttons">
			<input id="find-posts-close" type="button" class="button alignleft" value="***REMOVED*** esc_attr_e('Close'); ?>" />
			***REMOVED*** submit_button( __( 'Select' ), 'button-primary alignright', 'find-posts-submit', false ); ?>
		</div>
	</div>
***REMOVED***
}
...
?>
<title>***REMOVED*** bloginfo('name') ?> &rsaquo; ***REMOVED*** echo $title ?> &#8212; ***REMOVED*** _e('WordPress'); ?></title>
***REMOVED***
...
<body***REMOVED*** if ( isset($GLOBALS['body_id']) ) echo ' id="' . $GLOBALS['body_id'] . '"'; ?> class="wp-admin wp-core-ui no-js iframe ***REMOVED*** echo apply_filters( 'admin_body_class', '' ) . ' ' . $admin_body_class; ?>">
<script type="text/javascript">
//<![CDATA[
(function(){
...
<!DOCTYPE html>
<!--[if IE 8]>
<html xmlns="http://www.w3.org/1999/xhtml" class="ie8 ***REMOVED*** echo $admin_html_class; ?>" ***REMOVED*** do_action('admin_xml_ns'); ?> ***REMOVED*** language_attributes(); ?>>
<![endif]-->
<!--[if !(IE 8) ]><!-->
<html xmlns="http://www.w3.org/1999/xhtml" class="***REMOVED*** echo $admin_html_class; ?>" ***REMOVED*** do_action('admin_xml_ns'); ?> ***REMOVED*** language_attributes(); ?>>
<!--<![endif]-->
<head>
...
final class WP_Internal_Pointers {
	...
	private static function print_js( $pointer_id, $selector, $args ) {
		...
		//<![CDATA[
		(function($){
			var options = ***REMOVED*** echo json_encode( $args ); ?>, setup;
			...
			options = $.extend( options, {
				close: function() {
					$.post( ajaxurl, {
						pointer: '***REMOVED*** echo $pointer_id; ?>',
			...
			setup = function() {
				$('***REMOVED*** echo $selector; ?>').first().pointer( options ).pointer('open');
			};
...
function _local_storage_notice() {
	...
	<p class="local-restore">
		***REMOVED*** _e('The backup of this post in your browser is different from the version below.'); ?>
		<a class="restore-backup" href="#">***REMOVED*** _e('Restore the backup.'); ?></a>
	</p>
	<p class="undo-restore hidden">
		***REMOVED*** _e('Post restored successfully.'); ?>
		<a class="undo-restore-backup" href="#">***REMOVED*** _e('Undo.'); ?></a>
	</p>
	</div>
	***REMOVED***
}
