...
//         $grantTypeObject->validateParameters($parameters); TODO: Original was uncommented
        ...
        // TODO: Remove - not contained in original
        $parameters['client_id'] = $this->client_id;
        $parameters['client_secret'] = $this->client_secret;
     ...
     * @return array
     */
    // TODO: original was private
    protected function executeRequest($url, $parameters = array(), $http_method = self::HTTP_METHOD_GET, array $http_headers = null, $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART)
    {
        $curl_options = array(
