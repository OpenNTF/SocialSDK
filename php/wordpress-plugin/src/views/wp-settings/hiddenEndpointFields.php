...
<input style="display: none;" type="checkbox" id="require_sign_on" name="require_sign_on" value="require_sign_on" <?php echo (isset($viewData['require_sign_on']) && $viewData['require_sign_on'] == true ? 'checked="checked"' : "")?>/>
