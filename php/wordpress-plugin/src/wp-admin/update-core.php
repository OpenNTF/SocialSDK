...
function dismissed_updates() {
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			$('#show-dismissed').toggle(function(){$(this).text('***REMOVED*** echo $hide_text; ?>');}, function() {$(this).text('***REMOVED*** echo $show_text; ?>')});
...
function list_plugin_updates() {
	...
	?>
<h3>***REMOVED*** _e( 'Plugins' ); ?></h3>
<p>***REMOVED*** _e( 'The following plugins have new versions available. Check the ones you want to update and then click &#8220;Update Plugins&#8221;.' ); ?></p>
<form method="post" action="***REMOVED*** echo esc_url( $form_action ); ?>" name="upgrade-plugins" class="upgrade">
***REMOVED*** wp_nonce_field('upgrade-core'); ?>
<p><input id="upgrade-plugins" class="button" type="submit" value="***REMOVED*** esc_attr_e('Update Plugins'); ?>" name="upgrade" /></p>
<table class="widefat" cellspacing="0" id="update-plugins-table">
	<thead>
	<tr>
		<th scope="col" class="manage-column check-column"><input type="checkbox" id="plugins-select-all" /></th>
		<th scope="col" class="manage-column"><label for="plugins-select-all">***REMOVED*** _e('Select All'); ?></label></th>
	</tr>
	</thead>
	...
	<tr>
		...
		<th scope="col" class="manage-column"><label for="plugins-select-all-2">***REMOVED*** _e('Select All'); ?></label></th>
	</tr>
	</tfoot>
	<tbody class="plugins">
***REMOVED***
...
<p><input id="upgrade-plugins-2" class="button" type="submit" value="***REMOVED*** esc_attr_e('Update Plugins'); ?>" name="upgrade" /></p>
</form>
***REMOVED***
}
...
?>
<h3>***REMOVED*** _e( 'Themes' ); ?></h3>
<p>***REMOVED*** _e( 'The following themes have new versions available. Check the ones you want to update and then click &#8220;Update Themes&#8221;.' ); ?></p>
<p>***REMOVED*** printf( __( '<strong>Please Note:</strong> Any customizations you have made to theme files will be lost. Please consider using <a href="%s">child themes</a> for modifications.' ), __( 'http://codex.wordpress.org/Child_Themes' ) ); ?></p>
<form method="post" action="***REMOVED*** echo esc_url( $form_action ); ?>" name="upgrade-themes" class="upgrade">
***REMOVED*** wp_nonce_field('upgrade-core'); ?>
<p><input id="upgrade-themes" class="button" type="submit" value="***REMOVED*** esc_attr_e('Update Themes'); ?>" name="upgrade" /></p>
<table class="widefat" cellspacing="0" id="update-themes-table">
	<thead>
	<tr>
		<th scope="col" class="manage-column check-column"><input type="checkbox" id="themes-select-all" /></th>
		<th scope="col" class="manage-column"><label for="themes-select-all">***REMOVED*** _e('Select All'); ?></label></th>
	</tr>
	</thead>
	...
	<tr>
		...
		<th scope="col" class="manage-column"><label for="themes-select-all-2">***REMOVED*** _e('Select All'); ?></label></th>
	</tr>
	</tfoot>
	<tbody class="plugins">
***REMOVED***
...
<p><input id="upgrade-themes-2" class="button" type="submit" value="***REMOVED*** esc_attr_e('Update Themes'); ?>" name="upgrade" /></p>
</form>
***REMOVED***
}
...
function list_translation_updates() {
	...
	?>
	<h3>***REMOVED*** _e( 'Translations' ); ?></h3>
	<form method="post" action="***REMOVED*** echo esc_url( $form_action ); ?>" name="upgrade-themes" class="upgrade">
		<p>***REMOVED*** _e( 'Some of your translations are out of date.' ); ?></p>
		***REMOVED*** wp_nonce_field('upgrade-translations'); ?>
		<p><input class="button" type="submit" value="***REMOVED*** esc_attr_e( 'Update Translations' ); ?>" name="upgrade" /></p>
	</form>
	***REMOVED***
}
...
?>
	...
	***REMOVED*** screen_icon('tools'); ?>
	<h2>***REMOVED*** _e('Update WordPress'); ?></h2>
***REMOVED***
	...
	<script type="text/javascript">
	window.location = '***REMOVED*** echo self_admin_url( 'about.php?updated' ); ?>';
	</script>
	***REMOVED***
}
...
if ( 'upgrade-core' == $action ) {
	...
	<div class="wrap">
	***REMOVED*** screen_icon('tools'); ?>
	<h2>***REMOVED*** _e('WordPress Updates'); ?></h2>
	***REMOVED***
	if ( $upgrade_error ) {
