...
public class Util {
	...
	public static String[][]				JS_LIBS				= new String[][] {
			...
			{ "Dojo Toolkit 1.8.0 CDN", "dojo180cdn", "includes/dojo180cdn.jsp",
			"/library?lib=dojo&ver=1.8.0" },
			{ "Dojo Toolkit 1.8.0 CDN Async", "dojo180cdnasync", "includes/dojo180cdnasync.jsp",
			"/library?lib=dojo&ver=1.8.0" },
			{ "Dojo Toolkit 1.7.0 CDN", "dojo170cdn", "includes/dojo170cdn.jsp",
			"/library?lib=dojo&ver=1.7.0" },
			{ "Dojo Toolkit 1.7.0 CDN Async", "dojo170cdnasync", "includes/dojo170cdnasync.jsp",
			"/library?lib=dojo&ver=1.7.0" },
			...
			{ "jQuery 1.8.0 ScriptTag", "jquery180ST", "includes/jquery180ScriptTag.jsp",
			"/library?lib=jquery&ver=1.8.0" },
			// { "jQuery 1.8.0 Debug", "jquery180debug", "includes/jquery180debug.jsp", "/library?lib=jquery&ver=1.8.0" },
			{ "jQuery 1.9.1 CDN", "jquery191cdn", "includes/jquery191cdn.jsp",
			"/library?lib=jquery&ver=1.9.1" },
			{ "jQuery 1.9.1 CDN Debug", "jquery191cdndebug", "includes/jquery191cdndebug.jsp",
			"/library?lib=jquery&ver=1.9.1" }					};

	public static String[][]				THEMES				= new String[][] {
																// title, id
			{ "Dojo Claro", "dojo" }, { "Bootstrap", "bootstrap" }, { "One UI", "oneui" } };
	...
	public static String[]					ONE_UI_STYLES		= {
			...
			Context.get().getProperty("connections.url")
	...
	public static String getLibraryInclude(HttpServletRequest request) {
		...
		for (String[] element : JS_LIBS) {
			if (element[1].equals(id)) {
				libraryInclude = element[2];
				break;
			}
		}
