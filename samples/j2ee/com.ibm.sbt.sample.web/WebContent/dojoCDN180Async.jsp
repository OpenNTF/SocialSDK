...
request.setAttribute("dojoPath","http://ajax.googleapis.com/ajax/libs/dojo/1.8.0/dojo/dojo.js");  
request.setAttribute("dojoTheme","tundra");  
request.setAttribute("dojoCSSPath","http://ajax.googleapis.com/ajax/libs/dojo/1.7.0/dijit/themes/tundra/tundra.css");
request.setAttribute("toolkit",PathUtil.concat(baseUrl,"/library?ver=1.7.0",'/'));
%>
