...
<div class="wrap">
***REMOVED*** screen_icon(); ?>
<h2 id="add-new-user">***REMOVED*** _e('Add New User') ?></h2>
***REMOVED***
if ( ! empty( $messages ) ) {
...
***REMOVED*** } ?>
	<form action="***REMOVED*** echo network_admin_url('user-new.php?action=add-user'); ?>" id="adduser" method="post">
	...
	***REMOVED*** submit_button( __('Add User'), 'primary', 'add-user' ); ?>
	</form>
</div>
***REMOVED***
