...
<html>
<head>
<title>SBT JAVA Sample - Get All Bookmarks</title>
...
<body>
	...
	<%
		try {
			...
			parameters.put("ps", "5");
			EntityList<Bookmark> bookmarks = svc.getAllBookmarks(parameters);
			...
			out.println("<pre>");
			out.println("Problem Occurred while fetching all bookmarks: " + e.getMessage());
