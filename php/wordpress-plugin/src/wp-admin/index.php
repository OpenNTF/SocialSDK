...
***REMOVED*** if ( has_action( 'welcome_panel' ) && current_user_can( 'edit_theme_options' ) ) :
	...
	if ( $hide )
 	...
 	<div id="welcome-panel" class="***REMOVED*** echo esc_attr( $classes ); ?>">
 		***REMOVED*** wp_nonce_field( 'welcome-panel-nonce', 'welcomepanelnonce', false ); ?>
		<a class="welcome-panel-close" href="***REMOVED*** echo esc_url( admin_url( '?welcome=0' ) ); ?>">***REMOVED*** _e( 'Dismiss' ); ?></a>
		***REMOVED***
		/**
