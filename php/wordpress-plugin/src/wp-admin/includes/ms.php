...
function display_space_usage() {
	...
	?>
	<strong>***REMOVED*** printf( __( 'Used: %1$s%% of %2$s' ), number_format( $percent_used ), $space ); ?></strong>
	***REMOVED***
}
...
function upload_space_setting( $id ) {
	...
	?>
	<tr>
		<th>***REMOVED*** _e( 'Site Upload Space Quota '); ?></th>
		<td><input type="number" step="1" min="0" style="width: 100px" name="option[blog_upload_space]" value="***REMOVED*** echo $quota; ?>" /> ***REMOVED*** _e( 'MB (Leave blank for network default)' ); ?></td>
	</tr>
	***REMOVED***
}
...
function choose_primary_blog() {
	...
	<tr>
	***REMOVED*** /* translators: My sites label */ ?>
		<th scope="row">***REMOVED*** _e( 'Primary Site' ); ?></th>
		<td>
		***REMOVED***
		...
		if ( count( $all_blogs ) > 1 ) {
			...
			<select name="primary_blog">
				***REMOVED*** foreach( (array) $all_blogs as $blog ) {
					if ( $primary_blog == $blog->userblog_id )
						$found = true;
					?><option value="***REMOVED*** echo $blog->userblog_id ?>"***REMOVED*** selected( $primary_blog, $blog->userblog_id ); ?>>***REMOVED*** echo esc_url( get_home_url( $blog->userblog_id ) ) ?></option>***REMOVED***
				} ?>
			</select>
			***REMOVED***
			if ( !$found ) {
	...
	***REMOVED*** if ( in_array( get_site_option( 'registration' ), array( 'all', 'blog' ) ) ) : ?>
		<tr>
			<th scope="row" colspan="2" class="th-full">
				***REMOVED***
				...
				?>
				<a href="***REMOVED*** echo apply_filters( 'wp_signup_location', $signup_url ); ?>">***REMOVED*** _e( 'Create a New Site' ); ?></a>
			</th>
		</tr>
	***REMOVED*** endif; ?>
	</table>
