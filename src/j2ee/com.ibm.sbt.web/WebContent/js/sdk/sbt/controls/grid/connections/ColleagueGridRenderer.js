 ...
 * 
 */
define(["sbt/_bridge/declare", "dojo/string",
        "sbt/controls/grid/connections/ConnectionsGridRenderer",
        "sbt/i18n!sbt/controls/grid/connections/nls/ColleagueGridRenderer",
        "sbt/text!sbt/controls/grid/connections/templates/ColleagueItem.html",
        "sbt/text!sbt/controls/grid/connections/templates/ViewAll.html",
        "sbt/text!sbt/controls/grid/connections/templates/ColleagueItemFull.html"], 
     ...
     */
    declare("sbt.controls.grid.connections.ColleagueGridRenderer", ConnectionsGridRenderer, {
    ...
    return sbt.controls.grid.connections.ColleagueGridRenderer;
});