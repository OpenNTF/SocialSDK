 ...
 */
define(
		[ "../declare", "../config", "../lang", "../stringUtil", "../Promise", "./CommunityConstants", "../base/BaseService", "../base/BaseEntity",
				"../base/XmlDataHandler", "./ForumService" ],
		function(declare, config, lang, stringUtil, Promise, consts, BaseService, BaseEntity, XmlDataHandler, ForumService) {
			...
			/**
			 * Community class represents an entry for a Community feed returned by the Connections REST API.
			 * 
			 * @class Community
			...
			var Community = declare(BaseEntity, {
				...
				/**
				 * Return the community theme of the IBM Connections community from community ATOM entry document.
				 * 
				...
				/**
				 * Create a forum topc by sending an Atom entry document containing the new forum to the forum replies resource.
				 * 
				 ...
				 * @param {Object} [args] Object representing various parameters that can be passed to get a feed of members of a community. The parameters must
				 * be exactly as they are supported by IBM Connections like ps, sortBy etc.
				 */
				...
				/**
				 * Loads a member object with the atom entry associated with the member of the community. By default, a network call is made to load the atom
				 * entry document in the member object.
				 * 
				 * @method getMember
				 * @param {String} member id of the member.
				 * @param {Object} [args] Argument object
			...
			/**
			 * Member class represents an entry for a Member feed returned by the Connections REST API.
			 * 
			 * @class Member
			 * @namespace sbt.connections
			 */
			var Member = declare(BaseEntity, {
				...
				/**
				 * Loads the member object with the atom entry associated with the member. By default, a network call is made to load the atom entry document in
				 * the member object.
				 * 
				 * @method load
				 * @param {Object} [args] Argument object
			...
			/**
			 * Invite class represents an entry for a Invite feed returned by the Connections REST API.
			 * 
			 * @class Invite
			 * @namespace sbt.connections
			 */
			...
			var Event = declare(BaseEntity, {
				...
				/**
				 * The event instance uuid. This is per event instance, rather than per event. e.g. if an event spans multiple days each day will have its own
				 * eventInstUuid.
				 * 
				 ...
				 * 
				 * Recurrence information object consists of: frequency - 'daily' or 'weekly' interval - Week interval. Value is int between 1 and 5. until -
				 * The end date of the repeating event. allDay - 1 if an all day event, 0 otherwise. startDate - Start time of the event endDate - End time of
				 * the event byDay - Days of the week this event occurs, possible values are: SU,MO,TU,WE,TH,FR,SA
				 * 
			...
			var CommunityService = declare(BaseService, {
				...
				/**
				 * Get the All Communities feed to see a list of all public communities to which the authenticated user has access or pass in parameters to
				 * search for communities that match a specific criteria.
				 * 
				 * @method getPublicCommunities
				 * 
				 * @param {Object} [args] Object representing various parameters that can be passed to get a feed of my communities. The parameters must be
				 * exactly as they are supported by IBM Connections like ps, sortBy etc.
				 */
				...
				/**
				 * Get the My Communities feed to see a list of the communities to which the authenticated user is a member or pass in parameters to search for
				 * a subset of those communities that match a specific criteria.
				 * 
				...
				/**
				 * Get the Events for a community. See {{#crossLink "CommunityConstants/AtomCommunityEvents:attribute"}}{{/crossLink}} for a complete listing of
				 * parameters.
				 * 
				...
				/**
				 * Get a list of the outstanding community invitations of the currently authenticated user or provide parameters to search for a subset of those
				 * invitations.
				 * 
				 * @method getMyInvites
				 * @param {Object} [args] Object representing various parameters that can be passed to get a feed of members of a community. The parameters must
				 ...
				 * 
				 * @method newCommunity
				 * @param {Object} args Object containing the fields for the new Community
				 */
				 ...
				 * 
				 * @method newMember
				 * @param {Object} args Object containing the fields for the new Member
				 */
				 ...
				 * @param {Object} args Object containing the fields for the new Invite
				 */
				...
				/**
				 * Retrieve a community entry, use the edit link for the community entry which can be found in the my communities feed.
				 * 
				 * @method getCommunity
				 * @param {String } communityUuid
				 * @param {Object} args Object containing the query arguments to be sent (defined in IBM Connections Communities REST API)
				 */
				...
				/**
				 * Create a community by sending an Atom entry document containing the new community to the My Communities resource.
				 * 
				...
				/**
				 * Update a community by sending a replacement community entry document in Atom format to the existing community's edit web address. All
				 * existing community entry information will be replaced with the new data. To avoid deleting all existing data, retrieve any data you want to
				 * retain first, and send it back with this request. For example, if you want to add a new tag to a community entry, retrieve the existing tags,
				...
				/**
				 * Delete a community, use the HTTP DELETE method. Only the owner of a community can delete it. Deleted communities cannot be restored
				 * 
				...
				/*
				 * Return a Community instance from Community or JSON or String. Throws an error if the argument was neither.
				 */
				...
				/*
				 * Return a Community UUID from Community or communityUuid. Throws an error if the argument was neither or is invalid.
				 */
				...
				/*
				 * Return a Community Member from Member or memberId. Throws an error if the argument was neither or is invalid.
				 */
				...
				_constructCommunityPostData : function(community) {
					var transformer = function(value, key) {
						if (key == "getTags") {
							...
							value = stringUtil.transform(CommunityUuidTmpl, {
								"communityUuid" : value
							});
						} else if (key == "getCommunityTheme" && value) {
							value = stringUtil.transform(CommunityThemeTmpl, {
