...
<div class="wrap">
***REMOVED*** screen_icon(); ?>
<h2>***REMOVED*** echo esc_html( $title ); ?>  <a href="link-add.php" class="add-new-h2">***REMOVED*** echo esc_html_x('Add New', 'link'); ?></a></h2>

***REMOVED*** if ( isset( $_GET['added'] ) ) : ?>
<div id="message" class="updated"><p>***REMOVED*** _e('Link added.'); ?></p></div>
***REMOVED*** endif; ?>
...
<h3><label for="link_name">***REMOVED*** _ex('Name', 'link name') ?></label></h3>
<div class="inside">
	<input type="text" name="link_name" size="30" maxlength="255" value="***REMOVED*** echo esc_attr($link->link_name); ?>" id="link_name" />
    <p>***REMOVED*** _e('Example: Nifty blogging software'); ?></p>
</div>
</div>

<div id="addressdiv" class="stuffbox">
<h3><label for="link_url">***REMOVED*** _e('Web Address') ?></label></h3>
<div class="inside">
	<input type="text" name="link_url" size="30" maxlength="255" class="code" value="***REMOVED*** echo esc_attr($link->link_url); ?>" id="link_url" />
    <p>***REMOVED*** _e('Example: <code>http://wordpress.org/</code> &#8212; don&#8217;t forget the <code>http://</code>'); ?></p>
</div>
</div>

<div id="descriptiondiv" class="stuffbox">
<h3><label for="link_description">***REMOVED*** _e('Description') ?></label></h3>
<div class="inside">
	<input type="text" name="link_description" size="30" maxlength="255" value="***REMOVED*** echo isset($link->link_description) ? esc_attr($link->link_description) : ''; ?>" id="link_description" />
    <p>***REMOVED*** _e('This will be shown when someone hovers over the link in the blogroll, or optionally below the link.'); ?></p>
</div>
</div>
...
<input type="hidden" name="link_id" value="***REMOVED*** echo (int) $link_id; ?>" />
<input type="hidden" name="cat_id" value="***REMOVED*** echo (int) $cat_id ?>" />
***REMOVED*** else: ?>
