...
<div class="wrap">
***REMOVED*** screen_icon(); ?>
  <h2>***REMOVED*** esc_html_e('All Settings'); ?></h2>
  <form name="form" action="options.php" method="post" id="all-options">
  ***REMOVED*** wp_nonce_field('options-options') ?>
...
<input type="hidden" name="page_options" value="***REMOVED*** echo esc_attr( implode( ',', $options_to_update ) ); ?>" />

***REMOVED*** submit_button( __( 'Save Changes' ), 'primary', 'Update' ); ?>
