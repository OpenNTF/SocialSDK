 ...
 */
class SBTKFilesViewWidget extends SBTKBaseGridWidget {
	
	private $widget_id = 'ibm_sbtk_files_view_widget';
	private $widget_name = 'Files View Widget';
	private $widget_description = 'Displays a files view grid';
	private $widget_location =  '/views/widgets/ibm-sbtk-files-view.php';
	...
	public function form($instance) {
		...
		<p>
			<label for="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-created'); ?>">***REMOVED*** echo $GLOBALS[LANG]['creation-date']?>:</label> 
			<input ***REMOVED*** echo ($created ? 'checked="checked"' : ''); ?> id="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-created'); ?>" name="***REMOVED*** echo $this->get_field_name('ibm-sbtk-files-created'); ?>" type="checkbox" value="created" />
		</p>
		<p>
			<label for="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-author'); ?>">***REMOVED*** echo $GLOBALS[LANG]['author']?>:</label> 
			<input ***REMOVED*** echo ($author ? 'checked="checked"' : ''); ?> id="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-author'); ?>" name="***REMOVED*** echo $this->get_field_name('ibm-sbtk-files-author'); ?>" type="checkbox" value="author" />
		</p>
		<p>
			<label for="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-downloads-count'); ?>">***REMOVED*** echo $GLOBALS[LANG]['downloads-count']?>:</label> 
			<input ***REMOVED*** echo ($downloads ? 'checked="checked"' : ''); ?> id="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-downloads-count'); ?>" name="***REMOVED*** echo $this->get_field_name('ibm-sbtk-files-downloads-count'); ?>" type="checkbox" value="downloads" />
		</p>
		<p>
			<label for="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-comments-count'); ?>">***REMOVED*** echo $GLOBALS[LANG]['comments-count']?>:</label> 
			<input ***REMOVED*** echo ($comments ? 'checked="checked"' : ''); ?> id="***REMOVED*** echo $this->get_field_id('ibm-sbtk-files-comments-count'); ?>" name="***REMOVED*** echo $this->get_field_name('ibm-sbtk-files-comments-count'); ?>" type="checkbox" value="comments" />
		</p>
		<p>
