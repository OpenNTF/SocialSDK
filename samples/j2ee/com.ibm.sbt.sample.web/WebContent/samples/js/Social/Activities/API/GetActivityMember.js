require([ "sbt/dom", "sbt/json", "sbt/connections/ActivityService" ], function(dom,json,ActivityService) {
        ...
        var activityId = "%{name=sample.activityId|helpSnippetId=Social_Activities_API_GetActivityMember}";
        var memberId = "%{name=sample.memberId|helpSnippetId=Social_Activities_API_GetActivityMember}";
