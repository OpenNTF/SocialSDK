...
public class TopicsFeedHandler extends ForumsFeedHandler  {
	 ...
	 * @param service
	 */
	public TopicsFeedHandler(ForumService service){
		super(service);
	}
...
//		XmlDataHandler handler = new XmlDataHandler(node, ConnectionsConstants.nameSpaceCtx, expr);
		BaseForumEntity forum = new ForumTopic(getService(), (Node)data, nameSpaceCtx, expr);
		return forum;
	}
