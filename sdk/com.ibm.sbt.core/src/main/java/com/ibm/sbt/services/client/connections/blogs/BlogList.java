...
/**
 * Class used in representing List of Blog objects
 * @author Swati Singh
 */

public class BlogList extends BaseBlogEntityList  {

	public BlogList(Response requestData, BaseService service) {
