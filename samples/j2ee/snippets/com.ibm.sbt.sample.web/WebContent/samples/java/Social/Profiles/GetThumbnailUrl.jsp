...
<html>
<head>
	<title>SBT JAVA Sample - Get Thumbnail Url</title>
...
<body>
	...
	<%
		try {
			...
			if(profile != null){
				if (StringUtil.isNotEmpty(profile.getPronunciationUrl())) {
					out.println(profile.getThumbnailUrl());
					out.println("<br>");		
					out.println("<img src=" + profile.getThumbnailUrl() + "</img>");
				}else {
