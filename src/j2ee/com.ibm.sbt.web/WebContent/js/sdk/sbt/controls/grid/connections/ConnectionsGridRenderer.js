 ...
 * 
 */
define([ "sbt/_bridge/declare", "sbt/controls/grid/GridRenderer",
        "sbt/text!sbt/controls/grid/connections/templates/GridPager.html", 
        "sbt/text!sbt/controls/grid/connections/templates/GridSorter.html",
        "sbt/text!sbt/controls/grid/connections/templates/SortAnchor.html",
        "sbt/i18n!sbt/controls/grid/connections/nls/ConnectionsGridRenderer" ],
     ...
     */
    declare("sbt.controls.grid.connections.ConnectionsGridRenderer", GridRenderer, {
    ...
    return sbt.controls.grid.connections.ConnectionsGridRenderer;
});