...
public class TwitterRegEx {
    ...
    private static final String URL_VALID_PRECEEDING_CHARS = "(?:[^\\-/\"'!=A-Z0-9_@.\u202A-\u202E]|^)"; //TODO remove special @ sign due to encoding issues
  ...
  **/
    ...
    public static final Pattern EXTRACT_REPLY = Pattern.compile("^(?:[" + TwitterSpaces.getCharacterClass() + "])*" + AT_SIGNS + "([a-z0-9_]{1,20}).*", Pattern.CASE_INSENSITIVE);
