 ...
 *
 */
public class PersonFieldFeedHandler extends FieldFeedHandler implements IFeedHandler {
	 ...
	 * @param service
	 */
	public PersonFieldFeedHandler(ActivityService service){
		super(service);
	}
	...
	public Field createEntityFromData(Object data) {
		...
		Field field = new PersonField(service, handler);
		return field;
	}
}