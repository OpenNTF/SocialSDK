...
function twentythirteen_header_style() {
	...
	***REMOVED***
	...
	?>
		.site-header {
			background: url(***REMOVED*** header_image(); ?>) no-repeat scroll top;
	...
	***REMOVED***
	...
	?>
		.site-title,
		.site-description {
			color: #***REMOVED*** echo esc_attr( $text_color ); ?>;
		}
	***REMOVED*** endif; ?>
	</style>
	***REMOVED***
...
function twentythirteen_admin_header_image() {
	?>
	<div id="headimg" style="background: url(***REMOVED*** header_image(); ?>) no-repeat scroll top; background-size: 1600px auto;">
		***REMOVED*** $style = ' style="color:#' . get_header_textcolor() . ';"'; ?>
		<div class="home-link">
			<h1 class="displaying-header-text"><a id="name"***REMOVED*** echo $style; ?> onclick="return false;" href="#">***REMOVED*** bloginfo( 'name' ); ?></a></h1>
